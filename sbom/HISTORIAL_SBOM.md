...
| 2026-09-07 | No fijada | Win64 Debug; DejaVu Sans pasa a `required` al empaquetarla el instalador | No fijado; árbol con cambios locales | No reconciliado | `factuzam.cdx.json` rev. 4; `81351E8C82E6AB847EF741D30A50074E662A789BE305FFE7710050EE8620B8B5` | 1.7; esquema válido | No ejecutada; estado UNKNOWN | SUSTITUIDA |
| 2026-09-14 | No fijada | Win64 Debug; DejaVu Sans 2.37 retirada y alta manual de Source Sans 3 3.052 como `required` | No fijado; árbol con cambios locales | No reconciliado | `factuzam.cdx.json` rev. 5; `5CAC79C3B3BAC56A693929050E17F227D477E04D592D8B3865E57B0A6453327D` | 1.7; no revalidado con el esquema | No ejecutada; estado UNKNOWN | VERIFICACIÓN |
...
La revisión 5 retira DejaVu Sans 2.37, porque la aplicación dejó de referenciarla el 14 de septiembre de 2026, y da de alta a mano Source Sans 3 3.052 (Adobe, licencia OFL 1.1) con las huellas de las cuatro caras que empaqueta el instalador DEMO: Regular, Bold, Italic y Bold Italic. Como en las revisiones anteriores, la entrada no procede de Pascal Analyzer y no sobrevive a una regeneración mientras el normalizador no la inyecte.
