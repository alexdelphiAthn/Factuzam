...
| SBOM-004 | P1 | Anexo I, parte II | Completar proveedor, versión, licencia y evidencia de Delphi, DevExpress, FastReport, UniDAC/DAC, JCL, JVCL, SynEdit, DejaVu Sans y demás terceros. | EN PROGRESO | Catálogo curado y trazable de terceros. DejaVu Sans 2.37 ya lleva proveedor, versión, licencia, copyright y huellas por cara. | Desarrollo | Próxima entrega |
...
| SBOM-005 | P1 | Anexo I, parte II.1 | Hacer que `normalizar_sbom_pascal_analyzer.ps1` inyecte los activos redistribuibles que no son unidades Pascal, empezando por DejaVu Sans, para que no se pierdan al regenerar. | PENDIENTE | Normalizador que reproduce el componente y su digesto agregado sin intervención manual. | Desarrollo | Antes de SBOM-003 |
