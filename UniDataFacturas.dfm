  ...
  inherited unqryTablaG: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO fza_facturas'
        ...
        '  (NRO_FACTURA, SERIE_FACTURA, FECHA_FACTURA, ESCONSOLIDADA_FACT' +
        'URA, INSTANTECONSO_FACTURA, CODIGO_EMPRESA_FACTURA, RAZONSOCIAL_' +
        'EMPRESA_FACTURA, NIF_EMPRESA_FACTURA, MOVIL_EMPRESA_FACTURA, EMA' +
        'IL_EMPRESA_FACTURA, DIRECCION1_EMPRESA_FACTURA, DIRECCION2_EMPRE' +
        'SA_FACTURA, POBLACION_EMPRESA_FACTURA, PROVINCIA_EMPRESA_FACTURA' +
        ', CODIGO_PAIS_EMPRESA_FACTURA, NOMBRE_PAIS_EMPRESA_FACTURA, CPOS' +
        'TAL_EMPRESA_FACTURA, ESRETENCIONES_EMPRESA_FACTURA, GRUPO_ZONA_I' +
        'VA_EMPRESA_FACTURA, ESREGIMENESPECIALAGRICOLA_EMPRESA_FACTURA, C' +
        'ODIGO_CLIENTE_FACTURA, RAZONSOCIAL_CLIENTE_FACTURA, NIF_CLIENTE_' +
        'FACTURA, MOVIL_CLIENTE_FACTURA, EMAIL_CLIENTE_FACTURA, DIRECCION' +
        '1_CLIENTE_FACTURA, DIRECCION2_CLIENTE_FACTURA, POBLACION_CLIENTE' +
        '_FACTURA, PROVINCIA_CLIENTE_FACTURA, CPOSTAL_CLIENTE_FACTURA, CO' +
        'DIGO_PAIS_CLIENTE_FACTURA, NOMBRE_PAIS_CLIENTE_FACTURA, CODIGO_I' +
        'VA_FACTURA, ESIVA_RECARGO_CLIENTE_FACTURA, ESIVA_EXENTO_CLIENTE_' +
        'FACTURA, ESREGIMENESPECIALAGRICOLA_CLIENTE_FACTURA, ESRETENCIONE' +
        'S_CLIENTE_FACTURA, TARIFA_ARTICULO_CLIENTE_FACTURA, ESIMP_INCL_T' +
        'ARIFA_CLIENTE_FACTURA, ESINTRACOMUNITARIO_CLIENTE_FACTURA, ESIRP' +
        'F_IMP_INCL_ZONA_IVA_FACTURA, ESAPLICA_RE_ZONA_IVA_FACTURA, ESIVA' +
        'AGRICOLA_ZONA_IVA_FACTURA, PALABRA_REPORTS_ZONA_IVA_FACTURA, ESV' +
        'ENTA_ACTIVO_FIJO_FACTURA, PORCEN_IVAN_FACTURA, TOTAL_IVAN_FACTUR' +
        'A, PORCEN_REN_FACTURA, TOTAL_REN_FACTURA, TOTAL_BASEI_IVAN_FACTU' +
        'RA, PORCEN_IVAR_FACTURA, TOTAL_IVAR_FACTURA, PORCEN_RER_FACTURA,' +
        ' TOTAL_RER_FACTURA, TOTAL_BASEI_IVAR_FACTURA, PORCEN_IVAS_FACTUR' +
        'A, TOTAL_IVAS_FACTURA, PORCEN_RES_FACTURA, TOTAL_RES_FACTURA, TO' +
        'TAL_BASEI_IVAS_FACTURA, PORCEN_IVAE_FACTURA, TOTAL_IVAE_FACTURA,' +
        ' PORCEN_REE_FACTURA, TOTAL_REE_FACTURA, TOTAL_BASEI_IVAE_FACTURA' +
        ', TOTAL_BASES_FACTURA, TOTAL_IMPUESTOS_FACTURA, FORMA_PAGO_FACTU' +
        'RA, PORCEN_RETENCION_FACTURA, TOTAL_RETENCION_FACTURA, TOTAL_LIQ' +
        'UIDO_FACTURA, NRO_FACTURA_ABONO_FACTURA, SERIE_FACTURA_ABONO_FAC' +
        'TURA, TEXTO_LEGAL_FACTURA_CLIENTE_FACTURA, TEXTO_LEGAL_FACTURA_E' +
        'MPRESA_FACTURA, DOCUMENTO_FACTURA, COMENTARIOS_FACTURA, CONTADOR' +
        '_LINEAS_FACTURA, ESCREARARTICULOS_FACTURA, ESDESCRIPCIONES_AMP_F' +
        'ACTURA, ESFECHADEENTREGA_FACTURA, XML_FACTURA, INSTANTEMODIF, IN' +
        'STANTEALTA, USUARIOALTA, USUARIOMODIF)'
      'VALUES'
      
        '  (:NRO_FACTURA, :SERIE_FACTURA, :FECHA_FACTURA, :ESCONSOLIDADA_' +
        'FACTURA, :INSTANTECONSO_FACTURA, :CODIGO_EMPRESA_FACTURA, :RAZON' +
        'SOCIAL_EMPRESA_FACTURA, :NIF_EMPRESA_FACTURA, :MOVIL_EMPRESA_FAC' +
        'TURA, :EMAIL_EMPRESA_FACTURA, :DIRECCION1_EMPRESA_FACTURA, :DIRE' +
        'CCION2_EMPRESA_FACTURA, :POBLACION_EMPRESA_FACTURA, :PROVINCIA_E' +
        'MPRESA_FACTURA, :CODIGO_PAIS_EMPRESA_FACTURA, :NOMBRE_PAIS_EMPRE' +
        'SA_FACTURA, :CPOSTAL_EMPRESA_FACTURA, :ESRETENCIONES_EMPRESA_FAC' +
        'TURA, :GRUPO_ZONA_IVA_EMPRESA_FACTURA, :ESREGIMENESPECIALAGRICOL' +
        'A_EMPRESA_FACTURA, :CODIGO_CLIENTE_FACTURA, :RAZONSOCIAL_CLIENTE' +
        '_FACTURA, :NIF_CLIENTE_FACTURA, :MOVIL_CLIENTE_FACTURA, :EMAIL_C' +
        'LIENTE_FACTURA, :DIRECCION1_CLIENTE_FACTURA, :DIRECCION2_CLIENTE' +
        '_FACTURA, :POBLACION_CLIENTE_FACTURA, :PROVINCIA_CLIENTE_FACTURA' +
        ', :CPOSTAL_CLIENTE_FACTURA, :CODIGO_PAIS_CLIENTE_FACTURA, :NOMBR' +
        'E_PAIS_CLIENTE_FACTURA, :CODIGO_IVA_FACTURA, :ESIVA_RECARGO_CLIE' +
        'NTE_FACTURA, :ESIVA_EXENTO_CLIENTE_FACTURA, :ESREGIMENESPECIALAG' +
        'RICOLA_CLIENTE_FACTURA, :ESRETENCIONES_CLIENTE_FACTURA, :TARIFA_' +
        'ARTICULO_CLIENTE_FACTURA, :ESIMP_INCL_TARIFA_CLIENTE_FACTURA, :E' +
        'SINTRACOMUNITARIO_CLIENTE_FACTURA, :ESIRPF_IMP_INCL_ZONA_IVA_FAC' +
        'TURA, :ESAPLICA_RE_ZONA_IVA_FACTURA, :ESIVAAGRICOLA_ZONA_IVA_FAC' +
        'TURA, :PALABRA_REPORTS_ZONA_IVA_FACTURA, :ESVENTA_ACTIVO_FIJO_FA' +
        'CTURA, :PORCEN_IVAN_FACTURA, :TOTAL_IVAN_FACTURA, :PORCEN_REN_FA' +
        'CTURA, :TOTAL_REN_FACTURA, :TOTAL_BASEI_IVAN_FACTURA, :PORCEN_IV' +
        'AR_FACTURA, :TOTAL_IVAR_FACTURA, :PORCEN_RER_FACTURA, :TOTAL_RER' +
        '_FACTURA, :TOTAL_BASEI_IVAR_FACTURA, :PORCEN_IVAS_FACTURA, :TOTA' +
        'L_IVAS_FACTURA, :PORCEN_RES_FACTURA, :TOTAL_RES_FACTURA, :TOTAL_' +
        'BASEI_IVAS_FACTURA, :PORCEN_IVAE_FACTURA, :TOTAL_IVAE_FACTURA, :' +
        'PORCEN_REE_FACTURA, :TOTAL_REE_FACTURA, :TOTAL_BASEI_IVAE_FACTUR' +
        'A, :TOTAL_BASES_FACTURA, :TOTAL_IMPUESTOS_FACTURA, :FORMA_PAGO_F' +
        'ACTURA, :PORCEN_RETENCION_FACTURA, :TOTAL_RETENCION_FACTURA, :TO' +
        'TAL_LIQUIDO_FACTURA, :NRO_FACTURA_ABONO_FACTURA, :SERIE_FACTURA_' +
        'ABONO_FACTURA, :TEXTO_LEGAL_FACTURA_CLIENTE_FACTURA, :TEXTO_LEGA' +
        'L_FACTURA_EMPRESA_FACTURA, :DOCUMENTO_FACTURA, :COMENTARIOS_FACT' +
        'URA, :CONTADOR_LINEAS_FACTURA, :ESCREARARTICULOS_FACTURA, :ESDES' +
        'CRIPCIONES_AMP_FACTURA, :ESFECHADEENTREGA_FACTURA, :XML_FACTURA,' +
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'CHA_FACTURA = :FECHA_FACTURA, ESCONSOLIDADA_FACTURA = :ESCONSOLI' +
        'DADA_FACTURA, INSTANTECONSO_FACTURA = :INSTANTECONSO_FACTURA, CO' +
        'DIGO_EMPRESA_FACTURA = :CODIGO_EMPRESA_FACTURA, RAZONSOCIAL_EMPR' +
        'ESA_FACTURA = :RAZONSOCIAL_EMPRESA_FACTURA, NIF_EMPRESA_FACTURA ' +
        '= :NIF_EMPRESA_FACTURA, MOVIL_EMPRESA_FACTURA = :MOVIL_EMPRESA_F' +
        'ACTURA, EMAIL_EMPRESA_FACTURA = :EMAIL_EMPRESA_FACTURA, DIRECCIO' +
        'N1_EMPRESA_FACTURA = :DIRECCION1_EMPRESA_FACTURA, DIRECCION2_EMP' +
        'RESA_FACTURA = :DIRECCION2_EMPRESA_FACTURA, POBLACION_EMPRESA_FA' +
        'CTURA = :POBLACION_EMPRESA_FACTURA, PROVINCIA_EMPRESA_FACTURA = ' +
        ':PROVINCIA_EMPRESA_FACTURA, CODIGO_PAIS_EMPRESA_FACTURA = :CODIG' +
        'O_PAIS_EMPRESA_FACTURA, NOMBRE_PAIS_EMPRESA_FACTURA = :NOMBRE_PA' +
        'IS_EMPRESA_FACTURA, CPOSTAL_EMPRESA_FACTURA = :CPOSTAL_EMPRESA_F' +
        'ACTURA, ESRETENCIONES_EMPRESA_FACTURA = :ESRETENCIONES_EMPRESA_F' +
        'ACTURA, GRUPO_ZONA_IVA_EMPRESA_FACTURA = :GRUPO_ZONA_IVA_EMPRESA' +
        '_FACTURA, ESREGIMENESPECIALAGRICOLA_EMPRESA_FACTURA = :ESREGIMEN' +
        'ESPECIALAGRICOLA_EMPRESA_FACTURA, CODIGO_CLIENTE_FACTURA = :CODI' +
        'GO_CLIENTE_FACTURA, RAZONSOCIAL_CLIENTE_FACTURA = :RAZONSOCIAL_C' +
        'LIENTE_FACTURA, NIF_CLIENTE_FACTURA = :NIF_CLIENTE_FACTURA, MOVI' +
        'L_CLIENTE_FACTURA = :MOVIL_CLIENTE_FACTURA, EMAIL_CLIENTE_FACTUR' +
        'A = :EMAIL_CLIENTE_FACTURA, DIRECCION1_CLIENTE_FACTURA = :DIRECC' +
        'ION1_CLIENTE_FACTURA, DIRECCION2_CLIENTE_FACTURA = :DIRECCION2_C' +
        'LIENTE_FACTURA, POBLACION_CLIENTE_FACTURA = :POBLACION_CLIENTE_F' +
        'ACTURA, PROVINCIA_CLIENTE_FACTURA = :PROVINCIA_CLIENTE_FACTURA, ' +
        'CPOSTAL_CLIENTE_FACTURA = :CPOSTAL_CLIENTE_FACTURA, CODIGO_PAIS_' +
        'CLIENTE_FACTURA = :CODIGO_PAIS_CLIENTE_FACTURA, NOMBRE_PAIS_CLIE' +
        'NTE_FACTURA = :NOMBRE_PAIS_CLIENTE_FACTURA, CODIGO_IVA_FACTURA =' +
        ' :CODIGO_IVA_FACTURA, ESIVA_RECARGO_CLIENTE_FACTURA = :ESIVA_REC' +
        'ARGO_CLIENTE_FACTURA, ESIVA_EXENTO_CLIENTE_FACTURA = :ESIVA_EXEN' +
        'TO_CLIENTE_FACTURA, ESREGIMENESPECIALAGRICOLA_CLIENTE_FACTURA = ' +
        ':ESREGIMENESPECIALAGRICOLA_CLIENTE_FACTURA, ESRETENCIONES_CLIENT' +
        'E_FACTURA = :ESRETENCIONES_CLIENTE_FACTURA, TARIFA_ARTICULO_CLIE' +
        'NTE_FACTURA = :TARIFA_ARTICULO_CLIENTE_FACTURA, ESIMP_INCL_TARIF' +
        'A_CLIENTE_FACTURA = :ESIMP_INCL_TARIFA_CLIENTE_FACTURA, ESINTRAC' +
        'OMUNITARIO_CLIENTE_FACTURA = :ESINTRACOMUNITARIO_CLIENTE_FACTURA' +
        ', ESIRPF_IMP_INCL_ZONA_IVA_FACTURA = :ESIRPF_IMP_INCL_ZONA_IVA_F' +
        'ACTURA, ESAPLICA_RE_ZONA_IVA_FACTURA = :ESAPLICA_RE_ZONA_IVA_FAC' +
        'TURA, ESIVAAGRICOLA_ZONA_IVA_FACTURA = :ESIVAAGRICOLA_ZONA_IVA_F' +
        'ACTURA, PALABRA_REPORTS_ZONA_IVA_FACTURA = :PALABRA_REPORTS_ZONA' +
        '_IVA_FACTURA, ESVENTA_ACTIVO_FIJO_FACTURA = :ESVENTA_ACTIVO_FIJO' +
        '_FACTURA, PORCEN_IVAN_FACTURA = :PORCEN_IVAN_FACTURA, TOTAL_IVAN' +
        '_FACTURA = :TOTAL_IVAN_FACTURA, PORCEN_REN_FACTURA = :PORCEN_REN' +
        '_FACTURA, TOTAL_REN_FACTURA = :TOTAL_REN_FACTURA, TOTAL_BASEI_IV' +
        'AN_FACTURA = :TOTAL_BASEI_IVAN_FACTURA, PORCEN_IVAR_FACTURA = :P' +
        'ORCEN_IVAR_FACTURA, TOTAL_IVAR_FACTURA = :TOTAL_IVAR_FACTURA, PO' +
        'RCEN_RER_FACTURA = :PORCEN_RER_FACTURA, TOTAL_RER_FACTURA = :TOT' +
        'AL_RER_FACTURA, TOTAL_BASEI_IVAR_FACTURA = :TOTAL_BASEI_IVAR_FAC' +
        'TURA, PORCEN_IVAS_FACTURA = :PORCEN_IVAS_FACTURA, TOTAL_IVAS_FAC' +
        'TURA = :TOTAL_IVAS_FACTURA, PORCEN_RES_FACTURA = :PORCEN_RES_FAC' +
        'TURA, TOTAL_RES_FACTURA = :TOTAL_RES_FACTURA, TOTAL_BASEI_IVAS_F' +
        'ACTURA = :TOTAL_BASEI_IVAS_FACTURA, PORCEN_IVAE_FACTURA = :PORCE' +
        'N_IVAE_FACTURA, TOTAL_IVAE_FACTURA = :TOTAL_IVAE_FACTURA, PORCEN' +
        '_REE_FACTURA = :PORCEN_REE_FACTURA, TOTAL_REE_FACTURA = :TOTAL_R' +
        'EE_FACTURA, TOTAL_BASEI_IVAE_FACTURA = :TOTAL_BASEI_IVAE_FACTURA' +
        ', TOTAL_BASES_FACTURA = :TOTAL_BASES_FACTURA, TOTAL_IMPUESTOS_FA' +
        'CTURA = :TOTAL_IMPUESTOS_FACTURA, FORMA_PAGO_FACTURA = :FORMA_PA' +
        'GO_FACTURA, PORCEN_RETENCION_FACTURA = :PORCEN_RETENCION_FACTURA' +
        ', TOTAL_RETENCION_FACTURA = :TOTAL_RETENCION_FACTURA, TOTAL_LIQU' +
        'IDO_FACTURA = :TOTAL_LIQUIDO_FACTURA, NRO_FACTURA_ABONO_FACTURA ' +
        '= :NRO_FACTURA_ABONO_FACTURA, SERIE_FACTURA_ABONO_FACTURA = :SER' +
        'IE_FACTURA_ABONO_FACTURA, TEXTO_LEGAL_FACTURA_CLIENTE_FACTURA = ' +
        ':TEXTO_LEGAL_FACTURA_CLIENTE_FACTURA, TEXTO_LEGAL_FACTURA_EMPRES' +
        'A_FACTURA = :TEXTO_LEGAL_FACTURA_EMPRESA_FACTURA, DOCUMENTO_FACT' +
        'URA = :DOCUMENTO_FACTURA, COMENTARIOS_FACTURA = :COMENTARIOS_FAC' +
        'TURA, CONTADOR_LINEAS_FACTURA = :CONTADOR_LINEAS_FACTURA, ESCREA' +
        'RARTICULOS_FACTURA = :ESCREARARTICULOS_FACTURA, ESDESCRIPCIONES_' +
        'AMP_FACTURA = :ESDESCRIPCIONES_AMP_FACTURA, ESFECHADEENTREGA_FAC' +
        'TURA = :ESFECHADEENTREGA_FACTURA, XML_FACTURA = :XML_FACTURA, IN' +
    ...
    SQLLock.Strings = (
        ...
        'SELECT NRO_FACTURA, SERIE_FACTURA, FECHA_FACTURA, ESCONSOLIDADA_' +
        'FACTURA, INSTANTECONSO_FACTURA, CODIGO_EMPRESA_FACTURA, RAZONSOC' +
        'IAL_EMPRESA_FACTURA, NIF_EMPRESA_FACTURA, MOVIL_EMPRESA_FACTURA,' +
        ' EMAIL_EMPRESA_FACTURA, DIRECCION1_EMPRESA_FACTURA, DIRECCION2_E' +
        'MPRESA_FACTURA, POBLACION_EMPRESA_FACTURA, PROVINCIA_EMPRESA_FAC' +
        'TURA, CODIGO_PAIS_EMPRESA_FACTURA, NOMBRE_PAIS_EMPRESA_FACTURA, ' +
        'CPOSTAL_EMPRESA_FACTURA, ESRETENCIONES_EMPRESA_FACTURA, GRUPO_ZO' +
        'NA_IVA_EMPRESA_FACTURA, ESREGIMENESPECIALAGRICOLA_EMPRESA_FACTUR' +
        'A, CODIGO_CLIENTE_FACTURA, RAZONSOCIAL_CLIENTE_FACTURA, NIF_CLIE' +
        'NTE_FACTURA, MOVIL_CLIENTE_FACTURA, EMAIL_CLIENTE_FACTURA, DIREC' +
        'CION1_CLIENTE_FACTURA, DIRECCION2_CLIENTE_FACTURA, POBLACION_CLI' +
        'ENTE_FACTURA, PROVINCIA_CLIENTE_FACTURA, CPOSTAL_CLIENTE_FACTURA' +
        ', CODIGO_PAIS_CLIENTE_FACTURA, NOMBRE_PAIS_CLIENTE_FACTURA, CODI' +
        'GO_IVA_FACTURA, ESIVA_RECARGO_CLIENTE_FACTURA, ESIVA_EXENTO_CLIE' +
        'NTE_FACTURA, ESREGIMENESPECIALAGRICOLA_CLIENTE_FACTURA, ESRETENC' +
        'IONES_CLIENTE_FACTURA, TARIFA_ARTICULO_CLIENTE_FACTURA, ESIMP_IN' +
        'CL_TARIFA_CLIENTE_FACTURA, ESINTRACOMUNITARIO_CLIENTE_FACTURA, E' +
        'SIRPF_IMP_INCL_ZONA_IVA_FACTURA, ESAPLICA_RE_ZONA_IVA_FACTURA, E' +
        'SIVAAGRICOLA_ZONA_IVA_FACTURA, PALABRA_REPORTS_ZONA_IVA_FACTURA,' +
        ' ESVENTA_ACTIVO_FIJO_FACTURA, PORCEN_IVAN_FACTURA, TOTAL_IVAN_FA' +
        'CTURA, PORCEN_REN_FACTURA, TOTAL_REN_FACTURA, TOTAL_BASEI_IVAN_F' +
        'ACTURA, PORCEN_IVAR_FACTURA, TOTAL_IVAR_FACTURA, PORCEN_RER_FACT' +
        'URA, TOTAL_RER_FACTURA, TOTAL_BASEI_IVAR_FACTURA, PORCEN_IVAS_FA' +
        'CTURA, TOTAL_IVAS_FACTURA, PORCEN_RES_FACTURA, TOTAL_RES_FACTURA' +
        ', TOTAL_BASEI_IVAS_FACTURA, PORCEN_IVAE_FACTURA, TOTAL_IVAE_FACT' +
        'URA, PORCEN_REE_FACTURA, TOTAL_REE_FACTURA, TOTAL_BASEI_IVAE_FAC' +
        'TURA, TOTAL_BASES_FACTURA, TOTAL_IMPUESTOS_FACTURA, FORMA_PAGO_F' +
        'ACTURA, PORCEN_RETENCION_FACTURA, TOTAL_RETENCION_FACTURA, TOTAL' +
        '_LIQUIDO_FACTURA, NRO_FACTURA_ABONO_FACTURA, SERIE_FACTURA_ABONO' +
        '_FACTURA, TEXTO_LEGAL_FACTURA_CLIENTE_FACTURA, TEXTO_LEGAL_FACTU' +
        'RA_EMPRESA_FACTURA, DOCUMENTO_FACTURA, COMENTARIOS_FACTURA, CONT' +
        'ADOR_LINEAS_FACTURA, ESCREARARTICULOS_FACTURA, ESDESCRIPCIONES_A' +
        'MP_FACTURA, ESFECHADEENTREGA_FACTURA, XML_FACTURA, INSTANTEMODIF' +
        ', INSTANTEALTA, USUARIOALTA, USUARIOMODIF FROM fza_facturas'
      'WHERE'
