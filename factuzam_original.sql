-- ========================================
-- Backup generado: 26/03/2026 19:40:40
...
INSERT INTO `fza_articulos` (`CODIGO_ARTICULO`, `ACTIVO_ARTICULO`, `TIPO_ARTICULO`, `DESCRIPCION_ARTICULO`, `CODIGO_FAMILIA_ARTICULO`, `TIPOIVA_ARTICULO`, `ESACTIVO_FIJO_ARTICULO`, `TIPO_CANTIDAD_ARTICULO`, `ESVARIACION_ARTICULO`, `ESTRAZABLE_ARTICULO`, `ORDEN_ARTICULO`, `INSTANTEMODIF`, `INSTANTEALTA`, `USUARIOALTA`, `USUARIOMODIF`, `TIPO_VARIACION_ARTICULO`) VALUES
  ...
  ('DEMO-BASICO', 'S', 'ESTANDAR', 'Camiseta Algodón Demo', 'ROPA', 'N', 'N', 'Uds', 'S', 'N', NULL, '2026-03-26 17:34:00', '2026-03-26 17:34:00', 'Admin', '', 'TC_BASICO'),
  ('DEMO-CAMISA', 'S', 'ESTANDAR', 'Camisa Lino Demo', 'ROPA', '', 'N', 'Uds', 'S', 'N', NULL, '2026-03-26 19:12:40', '2026-03-26 19:15:56', '', 'Administrador', 'TC_DEMO'),
  ('DEMO-PRO', 'S', 'ESTANDAR', 'Cinturón Piel Demo', 'ROPA', 'N', 'N', 'Uds', 'S', 'N', NULL, '2026-03-26 17:34:00', '2026-03-26 17:34:00', 'Admin', '', 'TC_PRO'),
...
INSERT INTO `fza_articulos_conjuntos_asign` (`CODIGO_ARTICULO_ACA`, `ID_CONJUNTO_ACA`, `ID_ATRIBUTO_ACA`, `ES_GENERACION_AUTO`, `INSTANTEMODIF`, `INSTANTEALTA`, `USUARIOALTA`, `USUARIOMODIF`) VALUES
  ('DEMO-CAMISA', 9001, 'TAL', 'S', '2026-03-26 19:15:56', NULL, '', 'Administrador'),
  ('DEMO-CAMISA', 9002, 'COL', 'S', '2026-03-26 19:15:56', NULL, '', 'Administrador'),
...
INSERT INTO `fza_atributos_conjuntos` (`ID_CONJUNTO_AC`, `NOMBRE_AC`, `ID_VARIACION_AC`, `ID_ATRIBUTO_AC`, `ESACTIVO_AC`, `INSTANTEMODIF`, `INSTANTEALTA`, `USUARIOALTA`, `USUARIOMODIF`) VALUES
  (1001, 'S', '', 'TAL', 'S', '2026-03-26 17:34:00', NULL, '', ''),
  (1002, 'M', '', 'TAL', 'S', '2026-03-26 17:34:00', NULL, '', ''),
  (1003, 'L', '', 'TAL', 'S', '2026-03-26 17:34:00', NULL, '', ''),
  (1004, 'XL', '', 'TAL', 'S', '2026-03-26 17:34:00', NULL, '', ''),
  (9001, 'Tallas Hombre Standard', '', 'TAL', 'S', '2026-03-26 19:12:40', NULL, '', ''),
  (9002, 'Colores Básicos Verano', '', 'COL', 'S', '2026-03-26 19:12:40', NULL, '', '');
...
ORDER BY fza_tarifas.ORDEN_TARIFA, fza_articulos.ORDEN_ARTICULO;', '2026-03-22 18:38:10', '2026-03-22 18:38:10', 'Administrador', 'Administrador'),
  ('046', 'Modificar vi_articulos_tarifas', 'CREATE OR REPLACE VIEW vi_articulos_tarifas as select
...
WHERE sku.CODIGO_UNIDAD_SKU = ''ZAP-OXFORD/MARRON/43''', '2026-03-24 20:01:49', '2026-03-24 19:59:13', 'Administrador', 'Administrador'),
  ...
  ('051', 'datos demo', '-- =========================================================================
-- SCRIPT DE DATOS DEMO: CONJUNTOS, VALORES Y SKUs (MODELO NORMALIZADO)
-- =========================================================================

-- 1. CREAMOS EL ESQUEMA DE VARIACIÓN Y SUS ATRIBUTOS
INSERT IGNORE INTO fza_variaciones (CODIGO_VAR, NOMBRE_VAR, ESACTIVO_VAR) VALUES
(''TC_DEMO'', ''Talla y Color Demo'', ''S'');

INSERT IGNORE INTO fza_variaciones_atributos (ID_VA, ID_ATRIBUTO_VA, NOMBRE_VA, ORDEN_VA) VALUES
(''TC_DEMO'', ''TAL'', ''Talla'', 1),
(''TC_DEMO'', ''COL'', ''Color'', 2);

-- 2. CREAMOS LOS GRUPOS / CONJUNTOS (Los nombres de las agrupaciones)
INSERT IGNORE INTO fza_atributos_conjuntos (ID_CONJUNTO_AC, ID_ATRIBUTO_AC, NOMBRE_AC, ESACTIVO_AC) VALUES
(9001, ''TAL'', ''Tallas Hombre Standard'', ''S''),
(9002, ''COL'', ''Colores Básicos Verano'', ''S'');

-- 3. CREAMOS LOS VALORES REALES DE LOS ATRIBUTOS
INSERT IGNORE INTO fza_atributos_valores (ID_VALOR_AV, VALOR_AV) VALUES
(9101, ''S''), (9102, ''M''), (9103, ''L''), (9104, ''XL''),
(9201, ''BLANCO''), (9202, ''NEGRO''), (9203, ''AZUL MARINO'');

-- 4. METEMOS LOS VALORES DENTRO DE SUS GRUPOS (El detalle del conjunto)
INSERT IGNORE INTO fza_atributos_conjuntos_det (ID_CONJUNTO_ACD, ID_VALOR_ACD) VALUES
(9001, 9101), -- Tallas Hombre -> S
(9001, 9102), -- Tallas Hombre -> M
(9001, 9103), -- Tallas Hombre -> L
(9001, 9104), -- Tallas Hombre -> XL
(9002, 9201), -- Colores Básicos -> BLANCO
(9002, 9202), -- Colores Básicos -> NEGRO
(9002, 9203); -- Colores Básicos -> AZUL MARINO

-- 5. CREAMOS EL ARTÍCULO DE PRUEBA
INSERT IGNORE INTO fza_articulos 
(CODIGO_ARTICULO, DESCRIPCION_ARTICULO, ACTIVO_ARTICULO, ESVARIACION_ARTICULO, TIPO_VARIACION_ARTICULO) 
VALUES
(''DEMO-CAMISA'', ''Camisa Lino Demo'', ''S'', ''S'', ''TC_DEMO'');

-- 6. ASIGNAMOS LOS GRUPOS AL ARTÍCULO (Esta es la condición que pusimos para abrir la pantalla)
INSERT IGNORE INTO fza_articulos_conjuntos_asign (CODIGO_ARTICULO_ACA, ID_ATRIBUTO_ACA, ID_CONJUNTO_ACA) VALUES
(''DEMO-CAMISA'', ''TAL'', 9001), -- Le asignamos el grupo de Tallas Hombre
(''DEMO-CAMISA'', ''COL'', 9002); -- Le asignamos el grupo de Colores Básicos

-- =========================================================================
-- LA MAGIA: SIMULAMOS QUE YA SE GENERÓ UN SKU EN EL PASADO
-- =========================================================================

-- Creamos el código del SKU final
INSERT IGNORE INTO fza_articulos_skus (CODIGO_UNIDAD_SKU, CODIGO_ARTICULO_SKU) VALUES
(''DEMO-CAMISA/M/B'', ''DEMO-CAMISA'');
...
INSERT INTO `fza_usuarios` (`USUARIO_USUARIO`, `PASSWORD_USUARIO`, `GRUPO_USUARIO`, `ACTIVO_USUARIO`, `EMPRESADEF_USUARIO`, `DIMINUTIVO_TICKET_USUARIO`, `CODIGO_EMPLEADO_USUARIO`, `ULTIMOLOGIN_USUARIO`, `INSTANTEMODIF`, `INSTANTEALTA`, `USUARIOALTA`, `USUARIOMODIF`, `ALMACENDEF_USUARIO`, `CAJADEF_USUARIO`) VALUES
  ('Administrador', '4F8239A5B05A0E22D3DD4D7853808AF3', 'Administradores', 'S', '012', 'ALEX', '1', '2026-03-26 19:35:45', '2026-03-26 19:35:45', '2021-05-14 19:54:29', 'Administrador', 'Administrador', 'GEN', '1');
...
INSERT INTO `fza_usuarios_perfiles` (`USUARIO_GRUPO_PERFILES`, `KEY_PERFILES`, `SUBKEY_PERFILES`, `VALUE_PERFILES`, `VALUE_TEXT_PERFILES`, `TYPE_BLOB_PERFILES`, `VALUE_BLOB_PERFILES`, `INSTANTEMODIF`, `INSTANTEALTA`, `USUARIOALTA`, `USUARIOMODIF`) VALUES
  ...
  ('Administradores', 'frmMtoCajaParam', 'vgerArqueoTarjetas', 'False', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerAvisoStockWarning', 'Artículo sin Stock. Compruebe Stock en almacén', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerBusqArtStockOnly', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerBusqArtTarifaOnly', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerCaducidadDefVale', 'False', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerChkExistOnly', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerChkStockOnly', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerCodEmpleadoDefecto', '1', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerDefPrinter', 'Generic', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerDefTarifa', 'PVP', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerDescuentos', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerDiasCaducidadVale', '362', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerFillEmpleadoDefecto', 'False', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerFormatoImpPredet', '', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerMaxOpPending', '5', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerMoverLineaIdentif', 'False', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerRecuperaValePIN', 'False', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerReqRefDevolucion', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerShowCajaSelection', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerShowEmpleadoLinea', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerTipoImpresion', 'ESC POS', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
  ('Administradores', 'frmMtoCajaParam', 'vgerVentasCredito', 'True', NULL, NULL, NULL, '2026-03-22 16:25:50', '2026-03-22 16:25:50', 'Administradores', 'Administradores'),
...
INSERT INTO `fza_variaciones` (`CODIGO_VAR`, `NOMBRE_VAR`, `ESACTIVO_VAR`, `ORDEN_VAR`, `INSTANTEMODIF`, `INSTANTEALTA`, `USUARIOALTA`, `USUARIOMODIF`) VALUES
  ...
  ('TC_DEMO', 'Talla y Color Demo', 'S', NULL, '2026-03-26 19:12:40', NULL, '', '');
-- 2 registros exportados
...
-- Backup completado: 26/03/2026 19:40:45
