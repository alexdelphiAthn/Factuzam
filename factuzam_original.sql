...
-- ----------------------------
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'CARTERA-CUERO', '', NULL, 0.000000, '2026-01-08 18:42:39');
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'CARTERA-PIEL', '', NULL, 8.000000, '2026-01-08 18:44:28');
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'CHAQ-CUERO/NEGRO/L', '', NULL, 2.000000, '2026-01-12 07:59:51');
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'CHAQ-CUERO/NEGRO/XL', '', NULL, 3.000000, '2026-01-08 18:34:30');
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'FALD-JEAN/VAQUERO/L', '', NULL, 15.000000, '2026-01-08 18:34:03');
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'FALD-PLIS/VERDE/S', '', NULL, 20.000000, '2026-01-08 18:33:56');
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'ZAP-OXFORD/MARRON/43', '', NULL, 8.000000, '2026-01-08 18:34:12');
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'ZAP-OXFORD/NEGRO/42', '', NULL, 10.000000, '2026-01-08 18:33:52');
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'ZAP-TACÓN/ROJO/37', '', NULL, 5.000000, '2026-01-08 18:34:22');
...
CREATE TABLE `fza_formas_pago`  (
  ...
  `TIPO_COMPORTAMIENTO_FORMAP` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NULL DEFAULT 'EFECTIVO' COMMENT 'Lógica interna: EFECTIVO, TARJETA, VALE, DEUDA',
  `ES_REQ_REFERENCIA_FORMAP` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NULL DEFAULT 'N' COMMENT 'S=Obliga a introducir un número (ej: cod barras bono, nro autorización tarjeta)',
...
-- ----------------------------
INSERT INTO `fza_formas_pago` VALUES ('CB_REG', 'Regularización Deuda', 'EFECTIVO', 'N', 'N', 'N', 'S', 99, '2026-01-04 07:09:34', '0000-00-00 00:00:00', 'SISTEMA', 'SISTEMA');
INSERT INTO `fza_formas_pago` VALUES ('CRED', 'A Crédito / Pendiente', 'DEUDA', 'N', 'N', 'N', 'S', 3, '2026-01-04 07:09:34', '0000-00-00 00:00:00', 'SISTEMA', 'SISTEMA');
...
CREATE TABLE `fza_movimientos_almacen`  (
  ...
  PRIMARY KEY (`TIPO_DOC_MOV`, `SERIE_DOC_MOV`, `NRO_DOC_MOV`, `LINEA_MOV`) USING BTREE,
...
-- Triggers structure for table fza_caja_pagos
-- ----------------------------
DROP TRIGGER IF EXISTS `TRG_CALC_CAMBIO_UPDATE`;
delimiter ;;
...
-- Triggers structure for table fza_movimientos_almacen
-- ----------------------------
DROP TRIGGER IF EXISTS `TRG_MOVIMIENTOS_AI`;
delimiter ;;
...
-- Triggers structure for table fza_movimientos_almacen
-- ----------------------------
DROP TRIGGER IF EXISTS `TRG_MOVIMIENTOS_AD`;
delimiter ;;
...
-- Triggers structure for table fza_movimientos_almacen
-- ----------------------------
DROP TRIGGER IF EXISTS `TRG_MOVIMIENTOS_AI_LOTES`;
delimiter ;;
...
-- Triggers structure for table fza_movimientos_almacen
-- ----------------------------
DROP TRIGGER IF EXISTS `TRG_MOVIMIENTOS_AU`;
delimiter ;;
