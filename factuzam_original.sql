...
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'CARTERA-PIEL', '', NULL, 8.000000, '2026-01-08 18:44:28', 0.000000, 0.000000);
...
INSERT INTO `fza_articulos_stockactual` VALUES ('GEN', 'ZAP-OXFORD/NEGRO/42', '', NULL, 10.000000, '2026-01-08 18:33:52', 0.000000, 0.000000);
...
CREATE TABLE `fza_caja_formas_pago`  (
  ...
  `CODIGO_DIVISA_FORMAP` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `fza_caja_formas_pago` VALUES ('BONO', 'Bono ayuntamiento', 'S', 'N', NULL, NULL, 'EUR', 'N', 'N', 'N', 'S', 4, '2026-02-16 06:14:09', '0000-00-00 00:00:00', 'SISTEMA', 'SISTEMA');
INSERT INTO `fza_caja_formas_pago` VALUES ('EFE', 'Efectivo', 'N', 'N', NULL, NULL, 'EUR', 'N', 'S', 'S', 'S', 1, '2026-02-16 06:14:10', '0000-00-00 00:00:00', 'SISTEMA', 'SISTEMA');
INSERT INTO `fza_caja_formas_pago` VALUES ('TARJ', 'Tarjeta BBVA', 'N', 'N', NULL, NULL, 'EUR', 'N', 'N', 'N', 'S', 2, '2026-02-16 06:14:12', '0000-00-00 00:00:00', 'SISTEMA', 'SISTEMA');
...
INSERT INTO `fza_contadores` VALUES ('CL', '-', '-', 297, 3, 'S', 'S', '2026-01-21 17:22:27', '0000-00-00 00:00:00', 'Administrador', 'Administrador');
...
-- ----------------------------
INSERT INTO `fza_usuarios` VALUES ('Administrador', '4F8239A5B05A0E22D3DD4D7853808AF3', 'Administradores', 'S', '012', 'ALEX', '1', '2026-02-16 08:18:10', '2026-02-16 08:18:10', '2021-05-14 19:54:29', 'Administrador', 'Administrador', NULL, NULL);
...
INSERT INTO `fza_usuarios_perfiles` VALUES ('Administradores', 'inLibtb', 'oSimobolosProhibidos', '+-%/\\?*€\"\',', NULL, NULL, NULL, '2026-02-16 18:05:50', '2026-02-16 18:02:33', 'Administrador', 'Administrador');
...
BEGIN
    DECLARE v_nivel_elegido VARCHAR(200);

    -- Determinamos cuál es el nivel de mayor prioridad que tiene DATOS para este formulario
    SELECT USUARIO_GRUPO_PERFILES INTO v_nivel_elegido
    FROM fza_usuarios_perfiles
    ...
    -- Una vez sabemos cuál es el nivel ganador, devolvemos todas sus filas
    -- Si v_nivel_elegido es NULL (no hay nada), la consulta simplemente no devolverá filas.
    SELECT 
    ...
    FROM fza_usuarios_perfiles
    WHERE KEY_PERFILES = p_formulario 
      AND USUARIO_GRUPO_PERFILES = v_nivel_elegido;
