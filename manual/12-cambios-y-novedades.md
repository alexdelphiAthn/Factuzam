...
| Interfaz traducible desde un catálogo central, paquetes descargables `en-GB`, `ca-ES` y `zh-CN`, respaldo en español y editor independiente de traducciones. | [Otros ▸ Parámetros del entorno ▸ Apariencia ▸ Idioma](07-menu-otros.md#idioma-y-traducciones) |
