...
La librería **no** se compila dentro de `fzam.dproj`: es independiente, como las
utilidades `utilnormbbdd` / `utilmigsqlsrv`.
...
En producción, estos datos se cargan por UniDAC desde el esquema Factuzam; en
el ejemplo se sustituyen por el `.ini`.
