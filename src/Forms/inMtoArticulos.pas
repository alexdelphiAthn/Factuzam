...
type
  TfrmMtoArticulos = class(TfrmMtoGen)
    ...
    cxGridDBTableView1CODIGO_UNIDAD_SKU: TcxGridDBColumn;
    cxGridDBTableView1CODIGO_ARTICULO_SKU: TcxGridDBColumn;
    cxGridDBTableView1ESACTIVO_SKU: TcxGridDBColumn;
    cxGridDBTableView1INSTANTEMODIF: TcxGridDBColumn;
    cxGridDBTableView1INSTANTEALTA: TcxGridDBColumn;
    cxGridDBTableView1USUARIOALTA: TcxGridDBColumn;
    cxGridDBTableView1USUARIOMODIF: TcxGridDBColumn;
