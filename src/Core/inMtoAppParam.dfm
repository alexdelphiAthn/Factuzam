object frmMtoAppParam: TfrmMtoAppParam
  ...
  object JvInspectorDotNETPainter1: TJvInspectorDotNETPainter
    ...
    CategoryFont.Height = -18
    CategoryFont.Name = 'Source Sans 3'
    CategoryFont.Style = []
    NameFont.Charset = DEFAULT_CHARSET
    NameFont.Color = clWindowText
    NameFont.Height = -18
    NameFont.Name = 'Source Sans 3'
    NameFont.Style = []
    ValueFont.Charset = DEFAULT_CHARSET
    ValueFont.Color = clWindowText
    ValueFont.Height = -18
    ValueFont.Name = 'Source Sans 3'
    ValueFont.Style = []
    DrawNameEndEllipsis = False
    HideSelectFont.Charset = DEFAULT_CHARSET
    HideSelectFont.Color = clHighlightText
    HideSelectFont.Height = -18
    HideSelectFont.Name = 'Source Sans 3'
    HideSelectFont.Style = []
    SelectedFont.Charset = DEFAULT_CHARSET
    SelectedFont.Color = clHighlightText
    SelectedFont.Height = -18
    SelectedFont.Name = 'Source Sans 3'
    SelectedFont.Style = []
    Left = 608
    Top = 496
  end
