...
begin
  ...
  // cursor durante el recorrido. Sin esto cada Next provoca un
  // re-render del row anterior, limpiando los Values[] que acabamos
  // de fijar — solo la ultima iteracion sobrevivia.
  bk := ds.GetBookmark;
  ds.DisableControls;
  try
    ds.First;
