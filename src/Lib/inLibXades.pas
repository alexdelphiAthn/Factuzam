...
{                                                                              }
{  Descripcion:                                                                }
{    Firma XAdES Enveloped para XML generado por Factuzam. Usa el almacen      }
{    personal de certificados de Windows y firma con la clave privada oficial  }
{    sin exportarla ni invocar procesos externos.                              }
{******************************************************************************}
unit inLibXades;
