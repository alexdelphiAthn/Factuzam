inherited frmMtoMenuCaja: TfrmMtoMenuCaja
  ...
  object lblEntradaCambio: TcxLabel
    Left = 303
    Top = 176
    AutoSize = False
    Caption = 'Entrada de Cambio'
    ParentFont = False
    Style.BorderColor = clNone
    Style.BorderStyle = ebsNone
    Style.Edges = []
  ...
  object lblGastosCaja: TcxLabel
    Left = 302
    Top = 230
    AutoSize = False
    Caption = 'Gastos por caja'
    ParentFont = False
    Style.BorderColor = clNone
    Style.BorderStyle = ebsNone
    Style.Edges = []
