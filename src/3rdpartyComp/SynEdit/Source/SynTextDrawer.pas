...
begin
  GetTextExtentPoint32W(FStockBitmap.Canvas.Handle, Text, Count, Result);
end;
...
begin
  ...
  begin
    ...
    if Result = 0 then
    begin
      Result := FStockBitmap.Canvas.TextExtent(Char).cx;
...
var
  sz: TSize;
begin
  GetTextExtentPoint32W(FStockBitmap.Canvas.Handle, Text, Count, sz);
  Result := sz.cx;
end;
