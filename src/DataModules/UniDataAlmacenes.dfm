  ...
  inherited unqryTablaG: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO fza_almacenes'
        ...
        '  (CODIGO_ALM_ALM, CODIGO_EMP_ALM, ESACTIVO_ALM, NOMBRE_ALM_ALM, CODIGO_PADRE_ALM, ESFISICO_ALM, TIPO_USO_ALM, DIRECCION_ALM, POBLACION_ALM, CODIGO_POSTAL_ALM, TELEFONO_ALM, EMAIL_ALM, CODIGO_CLI_ALM,' +
        ' DESTINO_ACTUAL_ALM, ORIGEN_ACTUAL_ALM, ORDEN_ALM, INSTANTE_MODIF, INSTANTE_ALTA, USUARIO_ALTA, USUARIO_MODIF)'
      'VALUES'
      
        '  (:CODIGO_ALM_ALM, :CODIGO_EMP_ALM, :ESACTIVO_ALM, :NOMBRE_ALM_ALM, :CODIGO_PADRE_ALM, :ESFISICO_ALM, :TIPO_USO_ALM, :DIRECCION_ALM, :POBLACION_ALM, :CODIGO_POSTAL_ALM, :TELEFONO_ALM, :EMAIL_ALM, :CO' +
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  CODIGO_ALM_ALM = :CODIGO_ALM_ALM, CODIGO_EMP_ALM = :CODIGO_EMP_ALM, ESACTIVO_ALM = :ESACTIVO_ALM, NOMBRE_ALM_ALM = :NOMBRE_ALM_ALM, CODIGO_PADRE_ALM = :CODIGO_PADRE_ALM, ESFISICO_ALM = :ESFISICO_ALM' +
    ...
    SQLLock.Strings = (
        ...
        'SELECT CODIGO_ALM_ALM, CODIGO_EMP_ALM, ESACTIVO_ALM, NOMBRE_ALM_ALM, CODIGO_PADRE_ALM, ESFISICO_ALM, TIPO_USO_ALM, DIRECCION_ALM, POBLACION_ALM, CODIGO_POSTAL_ALM, TELEFONO_ALM, EMAIL_ALM, CODIGO_CLI_' +
