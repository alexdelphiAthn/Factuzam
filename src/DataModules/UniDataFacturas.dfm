inherited dmFacturas: TdmFacturas
  ...
  object unqryLinFacPrint: TUniQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
        ...
        '  `SERIE_FAC_FACLIN` = :`Old_SERIE_FACTURA_LINEA` AND `NUMERO_FAC_FACLIN` = :`Old_NRO_FACTURA_LINEA` AND `LINEA_LINEA` = :`Old_LINEA_LINEA`')
    SQLUpdate.Strings = (
  ...
  object unqryCliDataFac: TUniQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
      '  CODIGO_CLI_CLI = :Old_CODIGO_CLIENTE')
    SQLUpdate.Strings = (
      'UPDATE fza_clientes'
      'SET'
  ...
  object unqryFormaPago: TUniQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
      '  CODIGO_FP_FP = :Old_CODIGO_FORMAPAGO')
    SQLUpdate.Strings = (
  ...
  object unqryRecibos: TUniQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
        ...
        '  `NUMERO_FAC_REC` = :`Old_NRO_FACTURA_RECIBO` AND `SERIE_FAC_REC` = :`Old_SERIE_FACTURA_RECIBO` AND `NUMERO_PLAZO_REC` = :`Old_NRO_PLAZO_RECIBO`')
    SQLUpdate.Strings = (
      'UPDATE `fza_recibos`'
      'SET'
  ...
  object unqryRecibosPrint: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO fza_recibos'
        ...
        '  (NUMERO_FAC_REC, SERIE_FAC_REC, NUMERO_PLAZO_REC, FORMA_PAGO_ORIGEN_RECIBO_REC, FORMA_PAGO_DESCRIPCION_ORIGEN_RECIBO_REC, EUROS_RECIBO_REC, ESTADO_RECIBO, FECHA_EXPEDICION_RECIBO_REC, FECHA_VENCIMIE' +
      ...
      'VALUES'
        ...
        '  (:NUMERO_FAC_REC, :SERIE_FAC_REC, :NUMERO_PLAZO_REC, :FORMA_PAGO_ORIGEN_RECIBO_REC, :FORMA_PAGO_DESCRIPCION_ORIGEN_RECIBO_REC, :EUROS_RECIBO_REC, :ESTADO_RECIBO, :FECHA_EXPEDICION_RECIBO_REC, :FECHA' +
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'CIBO_REC = :FORMA_PAGO_DESCRIPCION_ORIGEN_RECIBO_REC, EUROS_RECIBO_REC = :EUROS_RECIBO_REC, ESTADO_RECIBO = :ESTADO_RECIBO, FECHA_EXPEDICION_RECIBO_REC = :FECHA_EXPEDICION_RECIBO_REC, FECHA_VENCIMIENT' +
    ...
    SQLRefresh.Strings = (
        ...
        'SELECT NUMERO_FAC_REC, SERIE_FAC_REC, NUMERO_PLAZO_REC, FORMA_PAGO_ORIGEN_RECIBO_REC, FORMA_PAGO_DESCRIPCION_ORIGEN_RECIBO_REC, EUROS_RECIBO_REC, ESTADO_RECIBO, FECHA_EXPEDICION_RECIBO_REC, FECHA_VENC' +
  ...
  object unqryConsolidacion: TUniQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
      '  ID_FACCON = :Old_ID_CONSOLIDACION')
    SQLUpdate.Strings = (
