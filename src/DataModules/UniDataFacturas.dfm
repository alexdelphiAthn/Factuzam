  ...
  object unqryLinFac: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO `fza_facturas_lineas`'
        ...
        'IGO_ART_FACLIN`, `CODIGO_FAM_FACLIN`, `NOMBRE_FAM_FACLIN`, `PREC' +
        ...
        ' `TIPO_IVA_ARTICULO_FACLIN`, `DESCRIPCION_ARTICULO_FACLIN`, `COD' +
        'IGO_TAR_FACLIN`, `CANTIDAD_FACLIN`, `PRECIO_SALIDA_FACLIN`, `POR' +
      ...
      'VALUES'
        ...
        'O_FACLIN`, :`CODIGO_TAR_FACLIN`, :`CANTIDAD_FACLIN`, :`PRECIO_SA' +
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'O_ART_FACLIN` = :`CODIGO_ART_FACLIN`, `CODIGO_FAM_FACLIN` = :`CO' +
        'DIGO_FAM_FACLIN`, `NOMBRE_FAM_FACLIN` = :`NOMBRE_FAM_FACLIN`, `P' +
        ...
        'ARTICULO_FACLIN`, `CODIGO_TAR_FACLIN` = :`CODIGO_TAR_FACLIN`, `C' +
