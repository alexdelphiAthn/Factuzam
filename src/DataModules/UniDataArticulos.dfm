inherited dmArticulos: TdmArticulos
  ...
  inherited unqryTablaG: TUniQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
      '  `CODIGO_ART_ART` = :`Old_CODIGO_ARTICULO`')
    SQLUpdate.Strings = (
  ...
  object unqryProveedoresArticulos: TUniQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
        ...
        '  `CODIGO_PRV_AP` = :`Old_CODIGO_PROVEEDOR`'
      
        ' AND `CODIGO_ART_AP` = :`Old_CODIGO_ARTICULO`')
    SQLUpdate.Strings = (
  ...
  object unqryProveedores: TUniQuery
    SQLDelete.Strings = (
      ...
      'WHERE'
        ...
        '  `CODIGO_PROVEEDOR_ARTICULOS_PROVEEDORES` = :`Old_CODIGO_PROVEEDOR`'
      
        ' AND `CODIGO_ARTICULO_ARTICULOS_PROVEEDORES` = :`Old_CODIGO_ARTICULO`')
    SQLUpdate.Strings = (
      'UPDATE `fza_articulos_proveedores`'
      'SET'
