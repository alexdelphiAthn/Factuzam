  ...
  object unqryTarifasArticulos: TUniQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO fza_articulos_tarifas'
        ...
        'INAL_TARIFA, PRECIO_DTO_TARIFA, PORCEN_DTO_TARIFA, FECHA_DESDE_T' +
        'ARIFA, FECHA_HASTA_TARIFA, INSTANTEMODIF, INSTANTEALTA, USUARIOA' +
        'LTA, USUARIOMODIF)'
      'VALUES'
      
        '  (:CODIGO_ARTICULO_TARIFA, :CODIGO_UNICO_TARIFA, :CODIGO_UNIDAD' +
        '_TARIFA, :CODIGO_TARIFA, :ACTIVO_TARIFA, :PRECIOSALIDA_TARIFA, :' +
        'PRECIOFINAL_TARIFA, :PRECIO_DTO_TARIFA, :PORCEN_DTO_TARIFA, :FEC' +
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '_TARIFA = :CODIGO_UNICO_TARIFA, CODIGO_UNIDAD_TARIFA = :CODIGO_U' +
        'NIDAD_TARIFA, CODIGO_TARIFA = :CODIGO_TARIFA, ACTIVO_TARIFA = :A' +
        'CTIVO_TARIFA, PRECIOSALIDA_TARIFA = :PRECIOSALIDA_TARIFA, PRECIO' +
        'FINAL_TARIFA = :PRECIOFINAL_TARIFA, PRECIO_DTO_TARIFA = :PRECIO_' +
        'DTO_TARIFA, PORCEN_DTO_TARIFA = :PORCEN_DTO_TARIFA, FECHA_DESDE_' +
        'TARIFA = :FECHA_DESDE_TARIFA, FECHA_HASTA_TARIFA = :FECHA_HASTA_' +
        'TARIFA, INSTANTEMODIF = :INSTANTEMODIF, INSTANTEALTA = :INSTANTE' +
        'ALTA, USUARIOALTA = :USUARIOALTA, USUARIOMODIF = :USUARIOMODIF'
      'WHERE'
      '  CODIGO_UNICO_TARIFA = :Old_CODIGO_UNICO_TARIFA')
    SQLLock.Strings = (
      
        'SELECT CODIGO_ARTICULO_TARIFA, CODIGO_UNICO_TARIFA, CODIGO_UNIDA' +
  ...
  object unqryDetallesAtributos: TUniQuery
    ...
    SQL.Strings = (
      ...
      '    sku.CODIGO_UNIDAD_SKU,'
        ...
        ' (Talla)'
      '    val.VALOR_AV AS VALOR_INTERNO,   -- Ej: '#39'ROJO'#39
      '    inf.CLAVE_INFO AS META_CLAVE,    -- Ej: '#39'COLOR_PROVEEDOR'#39
      '    inf.VALOR_INFO AS META_VALOR     -- Ej: '#39'RED-01'#39
