inherited dmArticulos: TdmArticulos
  ...
  inherited unqryTablaG: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO `fza_articulos`'
        ...
        '  (`CODIGO_ART_ART`, `ESACTIVO_ART`, `ORDEN_ART`, `DESCRIPCION_ART`, `CODIGO_FAM_ART`, `TIPO_IVA_ART`, `ESACTIVO_FIJO_ART`, `TIPO_CANTIDAD_ART`, `INSTANTE_MODIF`, `INSTANTE_ALTA`, `USUARIO_ALTA`, `USUARIO_MODIF`)'
      'VALUES'
      
        '  (:`CODIGO_ART_ART`, :`ESACTIVO_ART`, :`ORDEN_ART`, :`DESCRIPCION_ART`, :`CODIGO_FAM_ART`, :`TIPO_IVA_ART`, :`ESACTIVO_FIJO_ART`, :`TIPO_CANTIDAD_ART`, :`INSTANTE_MODIF`, :`INSTANTE_ALTA`, :`USUARIO_' +
        'ALTA`, :`USUARIO_MODIF`)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  `CODIGO_ART_ART` = :`CODIGO_ART_ART`, `ESACTIVO_ART` = :`ESACTIVO_ART`, `ORDEN_ART` = :`ORDEN_ART`, `DESCRIPCION_ART` = :`DESCRIPCION_ART`, `CODIGO_FAM_ART` = :`CODIGO_FAM_ART`, `TIPO_IVA_ART` = :`T' +
        'IPO_IVA_ART`, `ESACTIVO_FIJO_ART` = :`ESACTIVO_FIJO_ART`, `TIPO_CANTIDAD_ART` = :`TIPO_CANTIDAD_ART`, `INSTANTE_MODIF` = :`INSTANTE_MODIF`, `INSTANTE_ALTA` = :`INSTANTE_ALTA`, `USUARIO_ALTA` = :`USUAR' +
        'IO_ALTA`, `USUARIO_MODIF` = :`USUARIO_MODIF`'
      'WHERE'
      '  `CODIGO_ART_ART` = :`Old_CODIGO_ART_ART`')
    SQLLock.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'SELECT `CODIGO_ART_ART`, `ESACTIVO_ART`, `ORDEN_ART`, `DESCRIPCION_ART`, `CODIGO_FAM_ART`, `TIPO_IVA_ART`, `ESACTIVO_FIJO_ART`, `TIPO_CANTIDAD_ART`, `INSTANTE_MODIF`, `INSTANTE_ALTA`, `USUARIO_ALTA`, ' +
        '`USUARIO_MODIF` FROM `fza_articulos`'
      'WHERE'
  ...
  object unqryTarifasArticulos: TUniQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO FZA_articulos_tarifas'
        ...
        '  (CODIGO_ART_ARTTAR, CODIGO_UNICO_ARTTAR, CODIGO_UNIDAD_ARTTAR, CODIGO_TAR_ARTTAR, ESACTIVO_ARTTAR, PRECIO_SALIDA_ARTTAR, PRECIO_FINAL_ARTTAR, PRECIO_DTO_ARTTAR, PORCENTAJE_DTO_ARTTAR, FECHA_DESDE_AR' +
        'TTAR, FECHA_HASTA_ARTTAR, INSTANTE_MODIF, INSTANTE_ALTA, USUARIO_ALTA, USUARIO_MODIF)'
      'VALUES'
      
        '  (:CODIGO_ART_ARTTAR, :CODIGO_UNICO_ARTTAR, :CODIGO_UNIDAD_ARTTAR, :CODIGO_TAR_ARTTAR, :ESACTIVO_ARTTAR, :PRECIO_SALIDA_ARTTAR, :PRECIO_FINAL_ARTTAR, :PRECIO_DTO_ARTTAR, :PORCENTAJE_DTO_ARTTAR, :FECH' +
        'A_DESDE_ARTTAR, :FECHA_HASTA_ARTTAR, :INSTANTE_MODIF, :INSTANTE_ALTA, :USUARIO_ALTA, :USUARIO_MODIF)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  CODIGO_ART_ARTTAR = :CODIGO_ART_ARTTAR, CODIGO_UNICO_ARTTAR = :CODIGO_UNICO_ARTTAR, CODIGO_UNIDAD_ARTTAR = :CODIGO_UNIDAD_ARTTAR, CODIGO_TAR_ARTTAR = :CODIGO_TAR_ARTTAR, ESACTIVO_ARTTAR = :ESACTIVO_' +
        'ARTTAR, PRECIO_SALIDA_ARTTAR = :PRECIO_SALIDA_ARTTAR, PRECIO_FINAL_ARTTAR = :PRECIO_FINAL_ARTTAR, PRECIO_DTO_ARTTAR = :PRECIO_DTO_ARTTAR, PORCENTAJE_DTO_ARTTAR = :PORCENTAJE_DTO_ARTTAR, FECHA_DESDE_AR' +
        'TTAR = :FECHA_DESDE_ARTTAR, FECHA_HASTA_ARTTAR = :FECHA_HASTA_ARTTAR, INSTANTE_MODIF = :INSTANTE_MODIF, INSTANTE_ALTA = :INSTANTE_ALTA, USUARIO_ALTA = :USUARIO_ALTA, USUARIO_MODIF = :USUARIO_MODIF'
      'WHERE'
      '  CODIGO_UNICO_ARTTAR = :Old_CODIGO_UNICO_ARTTAR')
    SQLLock.Strings = (
      
        'SELECT CODIGO_ART_ARTTAR, CODIGO_UNICO_ARTTAR, CODIGO_UNIDAD_ARTTAR, CODIGO_TAR_ARTTAR, ESACTIVO_ARTTAR, PRECIO_SALIDA_ARTTAR, PRECIO_FINAL_ARTTAR, PRECIO_DTO_ARTTAR, PORCENTAJE_DTO_ARTTAR, FECHA_DESD' +
        'E_ARTTAR, FECHA_HASTA_ARTTAR, INSTANTE_MODIF, INSTANTE_ALTA, USUARIO_ALTA, USUARIO_MODIF FROM FZA_articulos_tarifas'
      'WHERE'
      '  CODIGO_UNICO_ARTTAR = :Old_CODIGO_UNICO_ARTTAR'
      'FOR UPDATE')
    SQLRefresh.Strings = (
  ...
  object unqryProveedoresArticulos: TUniQuery
    ...
    SQLDelete.Strings = (
      ...
      'WHERE'
      '  `CODIGO_PRV_AP` = :`Old_CODIGO_PRV_AP`'
      ' AND `CODIGO_ART_AP` = :`Old_CODIGO_ART_AP`')
    SQLUpdate.Strings = (
  ...
  object unqryProveedores: TUniQuery
    SQLDelete.Strings = (
      ...
      'WHERE'
        ...
        '  `CODIGO_PROVEEDOR_ARTICULOS_PROVEEDORES` = :`Old_CODIGO_PROVEEDOR_ARTICULOS_PROVEEDORES`'
      
        ' AND `CODIGO_ARTICULO_ARTICULOS_PROVEEDORES` = :`Old_CODIGO_ARTICULO_ARTICULOS_PROVEEDORES`')
    SQLUpdate.Strings = (
      'UPDATE `fza_articulos_proveedores`'
      'SET'
      ...
      '  `CODIGO_ARTICULO_ARTICULOS_PROVEEDORES` = :`CODIGO_ART_ART`, '
        ...
        '  `PRECIO_ULT_COMPRA_ARTICULOS_PROVEEDORES` = :`PRECIO_ULT_COMPRA`, '
  ...
  object unqryTiposIVA: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO fza_ivas_tipos'
        ...
        '  (CODIGO_ABREVIATURA_IVA_IVATIP, NOMBRE_TIPO_IVA_IVATIP, INSTANTE_MODIF, INSTANTE_ALTA, USUARIO_ALTA, USUARIO_MODIF)'
      'VALUES'
  ...
  object unqryVariacionesArticulos: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO fza_articulos_variaciones_def'
        ...
        '  (CODIGO_VARIACION_VARIACION, CODIGO_VARIACION, CODIGO_ARTICULO_VARIACION, CODIGO_COLUMNA_VARIACION, CODIGO_UNIDAD_VARIACION, CODIGO_UNICO_UNIDAD_VARIACION, VALOR_VARIACION, VALOR2_VARIACION, INSTANT' +
        'E_MODIF, INSTANTE_ALTA, USUARIO_ALTA, USUARIO_MODIF)'
      'VALUES'
      
        '  (:CODIGO_VARIACION_VARIACION, :CODIGO_VARIACION, :CODIGO_ARTICULO_VARIACION, :CODIGO_COLUMNA_VARIACION, :CODIGO_UNIDAD_VARIACION, :CODIGO_UNICO_UNIDAD_VARIACION, :VALOR_VARIACION, :VALOR2_VARIACION,' +
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  CODIGO_VARIACION_VARIACION = :CODIGO_VARIACION_VARIACION, CODIGO_VARIACION = :CODIGO_VARIACION, CODIGO_ARTICULO_VARIACION = :CODIGO_ARTICULO_VARIACION, CODIGO_COLUMNA_VARIACION = :CODIGO_COLUMNA_VAR' +
        'IACION, CODIGO_UNIDAD_VARIACION = :CODIGO_UNIDAD_VARIACION, CODIGO_UNICO_UNIDAD_VARIACION = :CODIGO_UNICO_UNIDAD_VARIACION, VALOR_VARIACION = :VALOR_VARIACION, VALOR2_VARIACION = :VALOR2_VARIACION, IN' +
        'STANTE_MODIF = :INSTANTE_MODIF, INSTANTE_ALTA = :INSTANTE_ALTA, USUARIO_ALTA = :USUARIO_ALTA, USUARIO_MODIF = :USUARIO_MODIF'
      'WHERE'
      '  CODIGO_UNIDAD_VARIACION = :Old_CODIGO_UNIDAD_VARIACION')
    SQLLock.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'SELECT CODIGO_VARIACION_VARIACION, CODIGO_VARIACION, CODIGO_ARTICULO_VARIACION, CODIGO_COLUMNA_VARIACION, CODIGO_UNIDAD_VARIACION, CODIGO_UNICO_UNIDAD_VARIACION, VALOR_VARIACION, VALOR2_VARIACION, INS' +
        'TANTE_MODIF, INSTANTE_ALTA, USUARIO_ALTA, USUARIO_MODIF FROM fza_articulos_variaciones_def'
      'WHERE'
  ...
  object unqryDetallesAtributos: TUniQuery
    ...
    SQL.Strings = (
      ...
      'FROM fza_articulos_skus sku'
        ...
        '-- 1. Enlazamos con la tabla intermedia para saber qu'#233' valores componen el SKU'
