  ...
  inherited unqryTablaG: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO fza_usuarios'
        ...
        '  (USUARIO_USU, PASSWORD_USU, GRUPO_USU, EMPRESA_DEFECTO_USU, DIMINUTIVO_TICKET_USU, ULTIMO_LOGIN_USU, INSTANTE_MODIF, INSTANTE_ALTA, USUARIO_ALTA, USUARIO_MODIF)'
      'VALUES'
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  USUARIO_USU = :USUARIO_USU, PASSWORD_USU = :PASSWORD_USU, GRUPO_USU = :GRUPO_USU, EMPRESA_DEFECTO_USU = :EMPRESA_DEFECTO_USU, DIMINUTIVO_TICKET_USU = :DIMINUTIVO_TICKET_USU' +
    ...
    SQLLock.Strings = (
        ...
        'SELECT USUARIO_USU, PASSWORD_USU, GRUPO_USU, EMPRESA_DEFECTO_USU, DIMINUTIVO_TICKET_USU, ULTIMO_LOGIN_USU, INSTANTE_MODIF, INSTANTE_ALTA, USUARIO_ALTA, USUARIO_MODIF FROM fza_usuarios'
      'WHERE'
      '  USUARIO_USU = :Old_USUARIO_USU'
      'FOR UPDATE')
    SQLRefresh.Strings = (
