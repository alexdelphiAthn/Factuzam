  ...
  inherited unqryTablaG: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO fza_compras_sesiones'
        ...
        '_POR_SKU_SES, ID_PV_TEMPORADA_SES, ESIVA_RECARGO_COMPRAS_SES)'
      'VALUES'
        ...
        'MPORADA_SES, :ESIVA_RECARGO_COMPRAS_SES)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        ':ID_PV_TEMPORADA_SES, ESIVA_RECARGO_COMPRAS_SES = :ESIVA_RECARG' +
        'O_COMPRAS_SES'
      'WHERE'
      '  SERIE_SES = :Old_SERIE_SES AND NUMERO_SES = :Old_NUMERO_SES')
    SQLLock.Strings = (
        ...
        'ECIO_POR_SKU_SES, ID_PV_TEMPORADA_SES, ESIVA_RECARGO_COMPRAS_SES' +
