  ...
  inherited unqryTablaG: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO `fza_articulos_familias`'
        ...
        '  (`CODIGO_FAM_FAM`, `ESACTIVO_FAM`, `ORDEN_FAM`, `ESDEFAULT_FAM`, `CODIGO_SUBFAMILIA_FAM`, `NOMBRE_FAM_FAM`, `DESCRIPCION_FAM`, `CONTADOR_ART_FAM`, `ESCONTADOR_ART_FAM`, `PAD_ART_FAM`, `INSTANTE_MODIF`, `INSTANTE_ALTA`, `USUARIO_ALTA`, `USUARIO_MODIF`)'
      'VALUES'
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'M_FAM` = :`NOMBRE_FAM_FAM`, `DESCRIPCION_FAM` = :`DESCRIPCION_FAM`, `CONTADOR_ART_FAM` = :`CONTADOR_ART_FAM`, `ESCONTADOR_ART_FAM` = :`ESCONTADOR_ART_FAM`, `PAD_ART_FAM` = :`PAD_ART_FAM`, `INSTANTE_MODIF` = :`INSTANTE_MODIF`, `INSTANTE_ALTA` = :`INSTANTE_ALTA`, `USUARIO_ALTA` = :`USUARIO_ALTA`, `USUARIO_MODIF` = :`USUA' +
        'RIO_MODIF`'
      'WHERE'
      '  `CODIGO_FAM_FAM` = :`Old_CODIGO_FAM_FAM`')
    SQLLock.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'SELECT `CODIGO_FAM_FAM`, `ESACTIVO_FAM`, `ORDEN_FAM`, `ESDEFAULT_FAM`, `CODIGO_SUBFAMILIA_FAM`, `NOMBRE_FAM_FAM`, `DESCRIPCION_FAM`, `CONTADOR_ART_FAM`, `ESCONTADOR_ART_FAM`, `PAD_ART_FAM`, `INSTANTE_MODIF`, `INSTANTE_ALTA`, `USUARIO_ALTA`, `USUARIO_MODIF` ' +
