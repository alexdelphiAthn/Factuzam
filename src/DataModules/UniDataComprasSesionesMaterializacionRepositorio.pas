...
const
  ...
  SQL_LINEAS_DOCUMENTO =
    ...
    '            ELSE L.DESCRIPCION_SESLIN END AS DESCRIPCION_SESLIN, ' +
    '       S.ESDESCRIPCION_BLANCO_SES, L.CODIGO_FAM_SESLIN, ' +
...
begin
  Result := Definicion(
    ...
    'DESCRIPCION_SESLIN,ESDESCRIPCION_BLANCO_SES,' +
    'CODIGO_FAM_SESLIN,TIPO_IVA,' +
