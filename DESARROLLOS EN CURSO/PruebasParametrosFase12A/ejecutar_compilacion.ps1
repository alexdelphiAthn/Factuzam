...
$temporal = Join-Path $raizTemporal ('fzam_fase12a_' + $PID)
...
Anotar ('Compilación Fase XII-A - ' + (Get-Date -Format 'yyyy-MM-dd HH:mm:ss'))
...
$prefijoSeguro = $raizTemporal.TrimEnd('\') + '\fzam_fase12a_'
