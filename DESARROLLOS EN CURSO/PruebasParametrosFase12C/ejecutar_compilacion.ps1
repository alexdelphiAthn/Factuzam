...
$temporal = Join-Path $raizTemporal ('fzam_fase12c_' + $PID)
...
Anotar ('Compilación Fase XII-C - ' + (Get-Date -Format 'yyyy-MM-dd HH:mm:ss'))
...
$prefijoSeguro = $raizTemporal.TrimEnd('\') + '\fzam_fase12c_'
