...
-- Base Origen: factuzam
-- Base Destino: alexzam
-- Generado: 07/08/2026 19:12:27
-- Modo: NO DELETE (sin eliminaciones)
-- Incluye: TRIGGERS
-- ========================================
...
-- Agregar columna: fza_albaranes.INSTANTE_MOVIMIENTO_ALB
ALTER TABLE `fza_albaranes` ADD COLUMN `INSTANTE_MOVIMIENTO_ALB` datetime NULL DEFAULT NULL COMMENT 'Instante efectivo del movimiento de stock';

-- Agregar columna: fza_albaranes.PORCENTAJE_RETENCION_ALB
ALTER TABLE `fza_albaranes` ADD COLUMN `PORCENTAJE_RETENCION_ALB` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_albaranes.TOTAL_RETENCION_ALB
ALTER TABLE `fza_albaranes` ADD COLUMN `TOTAL_RETENCION_ALB` decimal(18,6) NULL DEFAULT '0.000000';

-- Tabla nueva: fza_albaranes_celdas
...
-- Agregar índice secundario: IDX_ALBCEL_AV_PIVOT
ALTER TABLE `fza_albaranes_celdas` ADD INDEX `IDX_ALBCEL_AV_PIVOT` (`ID_AV_PIVOT_ALBCEL`);

-- Agregar columna: fza_albaranes_compra.INSTANTE_MOVIMIENTO_ALBC
ALTER TABLE `fza_albaranes_compra` ADD COLUMN `INSTANTE_MOVIMIENTO_ALBC` datetime NULL DEFAULT NULL COMMENT 'Instante efectivo del movimiento de stock';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR1_VALOR_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR1_VALOR_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR1_NOMBRE_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR1_NOMBRE_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR2_VALOR_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR2_VALOR_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR2_NOMBRE_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR2_NOMBRE_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR3_VALOR_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR3_VALOR_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR3_NOMBRE_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR3_NOMBRE_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR4_VALOR_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR4_VALOR_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR4_NOMBRE_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR4_NOMBRE_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR5_VALOR_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR5_VALOR_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.ATTR5_NOMBRE_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `ATTR5_NOMBRE_ALBCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_compra_lineas.NUM_ATRIBUTOS_ALBCLIN
ALTER TABLE `fza_albaranes_compra_lineas` ADD COLUMN `NUM_ATRIBUTOS_ALBCLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Atributos requeridos del articulo';

-- Modificar columna: fza_albaranes_lineas.CODIGO_UNIDAD_ALBLIN
ALTER TABLE `fza_albaranes_lineas` MODIFY COLUMN `CODIGO_UNIDAD_ALBLIN` varchar(50) NULL DEFAULT NULL;

-- Agregar columna: fza_albaranes_lineas.ATTR1_VALOR_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR1_VALOR_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR1_NOMBRE_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR1_NOMBRE_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR2_VALOR_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR2_VALOR_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR2_NOMBRE_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR2_NOMBRE_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR3_VALOR_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR3_VALOR_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR3_NOMBRE_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR3_NOMBRE_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR4_VALOR_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR4_VALOR_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR4_NOMBRE_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR4_NOMBRE_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR5_VALOR_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR5_VALOR_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.ATTR5_NOMBRE_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ATTR5_NOMBRE_ALBLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_albaranes_lineas.NUM_ATRIBUTOS_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `NUM_ATRIBUTOS_ALBLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Atributos requeridos del articulo';

-- Agregar columna: fza_albaranes_lineas.ID_AC_PIVOT_ALBLIN
ALTER TABLE `fza_albaranes_lineas` ADD COLUMN `ID_AC_PIVOT_ALBLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Conjunto pivotado en tallas horizontal (0 = sin pivote)';

-- Agregar índice: fza_albaranes_lineas.IDX_ALBLIN_UNIDAD
ALTER TABLE `fza_albaranes_lineas` ADD INDEX `IDX_ALBLIN_UNIDAD` (`CODIGO_UNIDAD_ALBLIN`);

-- Agregar columna: fza_articulos_atributos_basicos.ORDEN_AAB
ALTER TABLE `fza_articulos_atributos_basicos` ADD COLUMN `ORDEN_AAB` int(11) NULL DEFAULT NULL COMMENT 'Orden del valor dentro del articulo; en tallas procede de ocarttal.Orden.';

-- Agregar columna: fza_devoluciones_compra.INSTANTE_MOVIMIENTO_DEVC
ALTER TABLE `fza_devoluciones_compra` ADD COLUMN `INSTANTE_MOVIMIENTO_DEVC` datetime NULL DEFAULT NULL COMMENT 'Instante efectivo del movimiento de stock';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR1_VALOR_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR1_VALOR_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR1_NOMBRE_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR1_NOMBRE_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR2_VALOR_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR2_VALOR_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR2_NOMBRE_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR2_NOMBRE_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR3_VALOR_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR3_VALOR_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR3_NOMBRE_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR3_NOMBRE_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR4_VALOR_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR4_VALOR_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR4_NOMBRE_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR4_NOMBRE_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR5_VALOR_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR5_VALOR_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.ATTR5_NOMBRE_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `ATTR5_NOMBRE_DEVCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_devoluciones_compra_lineas.NUM_ATRIBUTOS_DEVCLIN
ALTER TABLE `fza_devoluciones_compra_lineas` ADD COLUMN `NUM_ATRIBUTOS_DEVCLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Atributos requeridos del articulo';

-- Modificar columna: fza_documentos_trabajo.ESTADO_DTR
ALTER TABLE `fza_documentos_trabajo` MODIFY COLUMN `ESTADO_DTR` varchar(20) NOT NULL DEFAULT 'ABIERTO';

-- Tabla nueva: fza_documentos_trabajo_celdas
...
-- Agregar índice secundario: IDX_DTRCEL_AV_PIVOT
ALTER TABLE `fza_documentos_trabajo_celdas` ADD INDEX `IDX_DTRCEL_AV_PIVOT` (`ID_AV_PIVOT_DTRCEL`);

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR1_VALOR_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR1_VALOR_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR1_NOMBRE_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR1_NOMBRE_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR2_VALOR_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR2_VALOR_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR2_NOMBRE_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR2_NOMBRE_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR3_VALOR_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR3_VALOR_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR3_NOMBRE_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR3_NOMBRE_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR4_VALOR_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR4_VALOR_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR4_NOMBRE_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR4_NOMBRE_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR5_VALOR_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR5_VALOR_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.ATTR5_NOMBRE_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ATTR5_NOMBRE_DTL` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_documentos_trabajo_lineas.NUM_ATRIBUTOS_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `NUM_ATRIBUTOS_DTL` int(11) NOT NULL DEFAULT '0' COMMENT 'Atributos requeridos del articulo';

-- Agregar columna: fza_documentos_trabajo_lineas.ID_AC_PIVOT_DTL
ALTER TABLE `fza_documentos_trabajo_lineas` ADD COLUMN `ID_AC_PIVOT_DTL` int(11) NOT NULL DEFAULT '0' COMMENT 'Conjunto pivotado en tallas horizontal (0 = sin pivote)';

-- Tabla nueva: fza_facturacion_caja_periodos
CREATE TABLE `fza_facturacion_caja_periodos` (
...
-- Agregar índice secundario: IDX_FACPER_ESTADO
ALTER TABLE `fza_facturacion_caja_periodos` ADD INDEX `IDX_FACPER_ESTADO` (`ESTADO_FACPER`);

-- Agregar índice secundario: IDX_FACPER_REVISION
ALTER TABLE `fza_facturacion_caja_periodos` ADD INDEX `IDX_FACPER_REVISION` (`MODALIDAD_FACPER`, `CODIGO_EMP_ORIGEN_FACPER`, `CODIGO_EMP_DESTINO_FACPER`, `FECHA_DESDE_FACPER`, `FECHA_HASTA_FACPER`);

-- Agregar columna: fza_facturas.PDF_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `PDF_FAC` longblob NULL DEFAULT NULL COMMENT 'PDF de la factura tal como se genero al consolidar/exportar';

-- Agregar columna: fza_facturas.NOMBRE_PDF_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `NOMBRE_PDF_FAC` varchar(200) NULL DEFAULT NULL COMMENT 'Nombre de fichero del PDF archivado';

-- Agregar columna: fza_facturas.TAMANO_PDF_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `TAMANO_PDF_FAC` bigint(20) NULL DEFAULT NULL COMMENT 'Tamano en bytes del PDF archivado';

-- Agregar columna: fza_facturas.HUELLA_PDF_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `HUELLA_PDF_FAC` varchar(64) NULL DEFAULT NULL COMMENT 'SHA-256 hexadecimal del PDF archivado';

-- Agregar columna: fza_facturas.INSTANTE_PDF_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `INSTANTE_PDF_FAC` datetime NULL DEFAULT NULL COMMENT 'Momento en que se archivo el PDF';

-- Agregar columna: fza_facturas.FORMATO_PDF_FAC
ALTER TABLE `fza_facturas` ADD COLUMN `FORMATO_PDF_FAC` varchar(200) NULL DEFAULT NULL COMMENT 'Formato de impresion con el que se genero el PDF archivado';

-- Agregar columna: fza_facturas_compra_lineas.ATTR1_VALOR_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR1_VALOR_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR1_NOMBRE_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR1_NOMBRE_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR2_VALOR_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR2_VALOR_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR2_NOMBRE_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR2_NOMBRE_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR3_VALOR_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR3_VALOR_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR3_NOMBRE_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR3_NOMBRE_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR4_VALOR_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR4_VALOR_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR4_NOMBRE_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR4_NOMBRE_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR5_VALOR_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR5_VALOR_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.ATTR5_NOMBRE_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `ATTR5_NOMBRE_FACCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_compra_lineas.NUM_ATRIBUTOS_FACCLIN
ALTER TABLE `fza_facturas_compra_lineas` ADD COLUMN `NUM_ATRIBUTOS_FACCLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Atributos requeridos del articulo';

-- Agregar columna: fza_facturas_lineas.ATTR1_VALOR_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR1_VALOR_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR1_NOMBRE_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR1_NOMBRE_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR2_VALOR_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR2_VALOR_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR2_NOMBRE_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR2_NOMBRE_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR3_VALOR_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR3_VALOR_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR3_NOMBRE_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR3_NOMBRE_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR4_VALOR_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR4_VALOR_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR4_NOMBRE_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR4_NOMBRE_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR5_VALOR_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR5_VALOR_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.ATTR5_NOMBRE_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `ATTR5_NOMBRE_FACLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_facturas_lineas.NUM_ATRIBUTOS_FACLIN
ALTER TABLE `fza_facturas_lineas` ADD COLUMN `NUM_ATRIBUTOS_FACLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Atributos requeridos del articulo';

-- Tabla nueva: fza_facturas_operaciones_caja
CREATE TABLE `fza_facturas_operaciones_caja` (
...
-- Agregar índice secundario: IDX_FACOP_EMPRESAS
ALTER TABLE `fza_facturas_operaciones_caja` ADD INDEX `IDX_FACOP_EMPRESAS` (`CODIGO_EMP_ORIGEN_FACOP`, `CODIGO_EMP_DESTINO_FACOP`);

-- Agregar índice secundario: IDX_FACOP_ESTADO
ALTER TABLE `fza_facturas_operaciones_caja` ADD INDEX `IDX_FACOP_ESTADO` (`ESTADO_FACOP`);

-- Agregar índice secundario: IDX_FACOP_FACTURA
ALTER TABLE `fza_facturas_operaciones_caja` ADD INDEX `IDX_FACOP_FACTURA` (`SERIE_FAC_FACOP`, `NUMERO_FAC_FACOP`);

-- Agregar índice secundario: IDX_FACOP_PERIODO
ALTER TABLE `fza_facturas_operaciones_caja` ADD INDEX `IDX_FACOP_PERIODO` (`ID_FACPER_FACOP`);

-- Agregar índice secundario: UQ_FACOP_OPERACION
ALTER TABLE `fza_facturas_operaciones_caja` ADD UNIQUE INDEX `UQ_FACOP_OPERACION` (`ID_OPCAJA_FACOP`);

-- Agregar columna: fza_inventarios.CONTADOR_LINEAS_INV
ALTER TABLE `fza_inventarios` ADD COLUMN `CONTADOR_LINEAS_INV` varchar(8) NOT NULL DEFAULT '00000000' COMMENT 'Contador de lineas de inventario';

-- Tabla nueva: fza_inventarios_celdas
...
-- Agregar índice secundario: IDX_INVCEL_AV_PIVOT
ALTER TABLE `fza_inventarios_celdas` ADD INDEX `IDX_INVCEL_AV_PIVOT` (`ID_AV_PIVOT_INVCEL`);

-- Agregar columna: fza_inventarios_lineas.ID_AC_PIVOT_INVLIN
ALTER TABLE `fza_inventarios_lineas` ADD COLUMN `ID_AC_PIVOT_INVLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Conjunto de atributos pivotado en tallas horizontal (0 = sin pivote)';

-- Agregar columna: fza_inventarios_lineas.ESPRECIO_MEDIO_CORREGIDO_INVLIN
ALTER TABLE `fza_inventarios_lineas` ADD COLUMN `ESPRECIO_MEDIO_CORREGIDO_INVLIN` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'S si el PMP nuevo fue indicado expresamente';

-- Modificar columna: fza_movimientos_almacen.LINEA_MOV
ALTER TABLE `fza_movimientos_almacen` MODIFY COLUMN `LINEA_MOV` varchar(10) NOT NULL COMMENT 'Linea del documento origen';

-- Agregar columna: fza_movimientos_almacen.CLAVE_FCVE_MOV
ALTER TABLE `fza_movimientos_almacen` ADD COLUMN `CLAVE_FCVE_MOV` varchar(50) NULL DEFAULT NULL;

-- Agregar índice: fza_movimientos_almacen.UX_MOV_CLAVE_FCVE
ALTER TABLE `fza_movimientos_almacen` ADD UNIQUE INDEX `UX_MOV_CLAVE_FCVE` (`CLAVE_FCVE_MOV`);

-- Tabla nueva: fza_pedidos_celdas
...
-- Agregar índice secundario: IDX_PEDCEL_AV_PIVOT
ALTER TABLE `fza_pedidos_celdas` ADD INDEX `IDX_PEDCEL_AV_PIVOT` (`ID_AV_PIVOT_PEDCEL`);

-- Agregar índice: fza_pedidos_compra_celdas.IDX_PEDCCEL_AV_PIVOT
ALTER TABLE `fza_pedidos_compra_celdas` ADD INDEX `IDX_PEDCCEL_AV_PIVOT` (`ID_AV_PIVOT_PEDCCEL`);

-- Agregar columna: fza_pedidos_compra_lineas.ATTR1_VALOR_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR1_VALOR_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR1_NOMBRE_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR1_NOMBRE_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR2_VALOR_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR2_VALOR_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR2_NOMBRE_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR2_NOMBRE_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR3_VALOR_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR3_VALOR_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR3_NOMBRE_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR3_NOMBRE_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR4_VALOR_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR4_VALOR_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR4_NOMBRE_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR4_NOMBRE_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR5_VALOR_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR5_VALOR_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.ATTR5_NOMBRE_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `ATTR5_NOMBRE_PEDCLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_compra_lineas.NUM_ATRIBUTOS_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `NUM_ATRIBUTOS_PEDCLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Atributos requeridos del articulo';

-- Agregar columna: fza_pedidos_compra_lineas.CANTIDAD_A_RECIBIR_PEDCLIN
ALTER TABLE `fza_pedidos_compra_lineas` ADD COLUMN `CANTIDAD_A_RECIBIR_PEDCLIN` decimal(19,6) NOT NULL DEFAULT '0.000000' COMMENT 'Marcada para recibir en el proximo albaran (banda A recibir del pivote)';

-- Agregar columna: fza_pedidos_lineas.CANTIDAD_A_ALBARANAR_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `CANTIDAD_A_ALBARANAR_PEDLIN` decimal(19,6) NULL DEFAULT '0.000000';

-- Agregar columna: fza_pedidos_lineas.CODIGO_UNIDAD_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `CODIGO_UNIDAD_PEDLIN` varchar(50) NOT NULL DEFAULT '' COMMENT 'SKU concreto de la linea (ColumnSKUcxGrid)';

-- Agregar columna: fza_pedidos_lineas.ATTR1_VALOR_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR1_VALOR_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR1_NOMBRE_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR1_NOMBRE_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR2_VALOR_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR2_VALOR_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR2_NOMBRE_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR2_NOMBRE_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR3_VALOR_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR3_VALOR_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR3_NOMBRE_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR3_NOMBRE_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR4_VALOR_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR4_VALOR_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR4_NOMBRE_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR4_NOMBRE_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR5_VALOR_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR5_VALOR_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.ATTR5_NOMBRE_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ATTR5_NOMBRE_PEDLIN` varchar(100) NOT NULL DEFAULT '';

-- Agregar columna: fza_pedidos_lineas.NUM_ATRIBUTOS_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `NUM_ATRIBUTOS_PEDLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Atributos requeridos del articulo';

-- Agregar columna: fza_pedidos_lineas.ID_AC_PIVOT_PEDLIN
ALTER TABLE `fza_pedidos_lineas` ADD COLUMN `ID_AC_PIVOT_PEDLIN` int(11) NOT NULL DEFAULT '0' COMMENT 'Conjunto pivotado en tallas horizontal (0 = sin pivote)';

-- Agregar índice: fza_pedidos_lineas.IDX_PEDLIN_UNIDAD
ALTER TABLE `fza_pedidos_lineas` ADD INDEX `IDX_PEDLIN_UNIDAD` (`CODIGO_UNIDAD_PEDLIN`);

-- Tabla nueva: fza_proformas_caja
CREATE TABLE `fza_proformas_caja` (
...
-- Agregar índice secundario: IDX_PROCAJ_EMP_FECHA
ALTER TABLE `fza_proformas_caja` ADD INDEX `IDX_PROCAJ_EMP_FECHA` (`CODIGO_EMP_PROCAJ`, `FECHA_PROCAJ`);

-- Agregar índice secundario: IDX_PROCAJ_ESTADO
ALTER TABLE `fza_proformas_caja` ADD INDEX `IDX_PROCAJ_ESTADO` (`ESTADO_PROCAJ`);

-- Agregar índice secundario: IDX_PROCAJ_PERIODO
ALTER TABLE `fza_proformas_caja` ADD INDEX `IDX_PROCAJ_PERIODO` (`FECHA_DESDE_PROCAJ`, `FECHA_HASTA_PROCAJ`);

-- Agregar índice secundario: IDX_PROCAJ_PERIODO_REG
ALTER TABLE `fza_proformas_caja` ADD INDEX `IDX_PROCAJ_PERIODO_REG` (`ID_FACPER_PROCAJ`);

-- Agregar índice secundario: UQ_PROCAJ_DOCUMENTO
ALTER TABLE `fza_proformas_caja` ADD UNIQUE INDEX `UQ_PROCAJ_DOCUMENTO` (`CODIGO_EMP_PROCAJ`, `SERIE_PROCAJ`, `NUMERO_PROCAJ`);

-- Tabla nueva: fza_proformas_caja_lineas
CREATE TABLE `fza_proformas_caja_lineas` (
...
-- Agregar índice secundario: IDX_PROCLIN_OPERACION
ALTER TABLE `fza_proformas_caja_lineas` ADD INDEX `IDX_PROCLIN_OPERACION` (`ID_OPCAJA_PROCLIN`);

-- Agregar índice secundario: IDX_PROCLIN_PROFORMA_ORIGEN
ALTER TABLE `fza_proformas_caja_lineas` ADD INDEX `IDX_PROCLIN_PROFORMA_ORIGEN` (`ID_PROCAJ_ORIGEN_PROCLIN`, `LINEA_PROCAJ_ORIGEN_PROCLIN`);

-- Agregar índice secundario: UQ_PROCLIN_ORIGEN
ALTER TABLE `fza_proformas_caja_lineas` ADD UNIQUE INDEX `UQ_PROCLIN_ORIGEN` (`ID_OPCAJA_PROCLIN`, `TIPO_VINCULO_PROCLIN`, `SERIE_FAC_ORIGEN_PROCLIN`, `NUMERO_FAC_ORIGEN_PROCLIN`, `LINEA_FAC_ORIGEN_PROCLIN`);

-- Tabla nueva: fza_prueba_skucel
...
-- Agregar columna: fza_traducciones.ESDESCARGADA_TRAD
ALTER TABLE `fza_traducciones` ADD COLUMN `ESDESCARGADA_TRAD` varchar(1) NOT NULL DEFAULT 'N';

-- Agregar índice: fza_traducciones.IDX_TRAD_DESCARGADA_IDIOMA
ALTER TABLE `fza_traducciones` ADD INDEX `IDX_TRAD_DESCARGADA_IDIOMA` (`ESDESCARGADA_TRAD`, `IDIOMA_TRAD`);

-- Tabla nueva: fza_ventas_ws_cola
...
CREATE ALGORITHM=UNDEFINED  VIEW `vi_albaranes` AS select `a`.`NUMERO_ALB` AS `NUMERO_ALB`,`a`.`SERIE_ALB` AS `SERIE_ALB`,`a`.`FECHA_ALB` AS `FECHA_ALB`,`a`.`INSTANTE_MOVIMIENTO_ALB` AS `INSTANTE_MOVIMIENTO_ALB`,`a`.`ESCONSOLIDADO_ALB` AS `ESCONSOLIDADO_ALB`,`a`.`ESTADO_ALB` AS `ESTADO_ALB`,`a`.`NUMERO_PED_ALB` AS `NUMERO_PED_ALB`,`a`.`SERIE_PED_ALB` AS `SERIE_PED_ALB`,`a`.`NUMERO_FAC_ALB` AS `NUMERO_FAC_ALB`,`a`.`SERIE_FAC_ALB` AS `SERIE_FAC_ALB`,`a`.`CODIGO_EMP_ALB` AS `CODIGO_EMP_ALB`,`a`.`CODIGO_ALM_ALB` AS `CODIGO_ALM_ALB`,`a`.`RAZON_SOCIAL_EMPRESA_ALB` AS `RAZON_SOCIAL_EMPRESA_ALB`,`a`.`NIF_EMPRESA_ALB` AS `NIF_EMPRESA_ALB`,`a`.`MOVIL_EMPRESA_ALB` AS `MOVIL_EMPRESA_ALB`,`a`.`EMAIL_EMPRESA_ALB` AS `EMAIL_EMPRESA_ALB`,`a`.`DIRECCION1_EMPRESA_ALB` AS `DIRECCION1_EMPRESA_ALB`,`a`.`DIRECCION2_EMPRESA_ALB` AS `DIRECCION2_EMPRESA_ALB`,`a`.`POBLACION_EMPRESA_ALB` AS `POBLACION_EMPRESA_ALB`,`a`.`PROVINCIA_EMPRESA_ALB` AS `PROVINCIA_EMPRESA_ALB`,`a`.`CODIGO_PAI_EMPRESA_ALB` AS `CODIGO_PAI_EMPRESA_ALB`,`a`.`NOMBRE_PAI_EMPRESA_ALB` AS `NOMBRE_PAI_EMPRESA_ALB`,`a`.`CODIGO_POSTAL_EMPRESA_ALB` AS `CODIGO_POSTAL_EMPRESA_ALB`,`a`.`GRUPO_ZONA_IVA_EMPRESA_ALB` AS `GRUPO_ZONA_IVA_EMPRESA_ALB`,`a`.`CODIGO_CLI_ALB` AS `CODIGO_CLI_ALB`,`a`.`RAZON_SOCIAL_CLIENTE_ALB` AS `RAZON_SOCIAL_CLIENTE_ALB`,`a`.`NIF_CLIENTE_ALB` AS `NIF_CLIENTE_ALB`,`a`.`MOVIL_CLIENTE_ALB` AS `MOVIL_CLIENTE_ALB`,`a`.`EMAIL_CLIENTE_ALB` AS `EMAIL_CLIENTE_ALB`,`a`.`DIRECCION1_CLIENTE_ALB` AS `DIRECCION1_CLIENTE_ALB`,`a`.`DIRECCION2_CLIENTE_ALB` AS `DIRECCION2_CLIENTE_ALB`,`a`.`POBLACION_CLIENTE_ALB` AS `POBLACION_CLIENTE_ALB`,`a`.`PROVINCIA_CLIENTE_ALB` AS `PROVINCIA_CLIENTE_ALB`,`a`.`CODIGO_POSTAL_CLIENTE_ALB` AS `CODIGO_POSTAL_CLIENTE_ALB`,`a`.`CODIGO_PAI_CLIENTE_ALB` AS `CODIGO_PAI_CLIENTE_ALB`,`a`.`NOMBRE_PAI_CLIENTE_ALB` AS `NOMBRE_PAI_CLIENTE_ALB`,`a`.`NOMBRE_CLI_ENVIO_ALB` AS `NOMBRE_CLI_ENVIO_ALB`,`a`.`MOVIL_CLIENTE_ENVIO_ALB` AS `MOVIL_CLIENTE_ENVIO_ALB`,`a`.`DIRECCION1_CLIENTE_ENVIO_ALB` AS `DIRECCION1_CLIENTE_ENVIO_ALB`,`a`.`DIRECCION2_CLIENTE_ENVIO_ALB` AS `DIRECCION2_CLIENTE_ENVIO_ALB`,`a`.`POBLACION_CLIENTE_ENVIO_ALB` AS `POBLACION_CLIENTE_ENVIO_ALB`,`a`.`PROVINCIA_CLIENTE_ENVIO_ALB` AS `PROVINCIA_CLIENTE_ENVIO_ALB`,`a`.`CODIGO_POSTAL_CLIENTE_ENVIO_ALB` AS `CODIGO_POSTAL_CLIENTE_ENVIO_ALB`,`a`.`CODIGO_PAI_CLIENTE_ENVIO_ALB` AS `CODIGO_PAI_CLIENTE_ENVIO_ALB`,`a`.`NOMBRE_PAI_CLIENTE_ENVIO_ALB` AS `NOMBRE_PAI_CLIENTE_ENVIO_ALB`,`a`.`TRANSPORTISTA_ALB` AS `TRANSPORTISTA_ALB`,`a`.`CODIGO_IVA_ALB` AS `CODIGO_IVA_ALB`,`a`.`ESIVA_RECARGO_CLIENTE_ALB` AS `ESIVA_RECARGO_CLIENTE_ALB`,`a`.`ESIVA_EXENTO_CLIENTE_ALB` AS `ESIVA_EXENTO_CLIENTE_ALB`,`a`.`ESINTRACOMUNITARIO_CLIENTE_ALB` AS `ESINTRACOMUNITARIO_CLIENTE_ALB`,`a`.`TARIFA_ARTICULO_CLIENTE_ALB` AS `TARIFA_ARTICULO_CLIENTE_ALB`,`a`.`ESIMP_INCL_TARIFA_CLIENTE_ALB` AS `ESIMP_INCL_TARIFA_CLIENTE_ALB`,`a`.`PORCENTAJE_IVAN_ALB` AS `PORCENTAJE_IVAN_ALB`,`a`.`TOTAL_IVAN_ALB` AS `TOTAL_IVAN_ALB`,`a`.`PORCENTAJE_IVAR_ALB` AS `PORCENTAJE_IVAR_ALB`,`a`.`TOTAL_IVAR_ALB` AS `TOTAL_IVAR_ALB`,`a`.`PORCENTAJE_IVAS_ALB` AS `PORCENTAJE_IVAS_ALB`,`a`.`TOTAL_IVAS_ALB` AS `TOTAL_IVAS_ALB`,`a`.`PORCENTAJE_IVAE_ALB` AS `PORCENTAJE_IVAE_ALB`,`a`.`TOTAL_IVAE_ALB` AS `TOTAL_IVAE_ALB`,`a`.`TOTAL_BASES_ALB` AS `TOTAL_BASES_ALB`,`a`.`TOTAL_IMPUESTOS_ALB` AS `TOTAL_IMPUESTOS_ALB`,`a`.`PORCENTAJE_RETENCION_ALB` AS `PORCENTAJE_RETENCION_ALB`,`a`.`TOTAL_RETENCION_ALB` AS `TOTAL_RETENCION_ALB`,`a`.`TOTAL_LIQUIDO_ALB` AS `TOTAL_LIQUIDO_ALB`,`a`.`FORMA_PAGO_ALB` AS `FORMA_PAGO_ALB`,`a`.`CONTADOR_LINEAS_ALB` AS `CONTADOR_LINEAS_ALB`,`a`.`COMENTARIOS_ALB` AS `COMENTARIOS_ALB`,`a`.`OBSERVACIONES_ALB` AS `OBSERVACIONES_ALB`,`a`.`INSTANTE_MODIF` AS `INSTANTE_MODIF`,`a`.`INSTANTE_ALTA` AS `INSTANTE_ALTA`,`a`.`USUARIO_ALTA` AS `USUARIO_ALTA`,`a`.`USUARIO_MODIF` AS `USUARIO_MODIF`,`alm`.`NOMBRE_ALM_ALM` AS `NOMBRE_ALM_ALB` from (`fza_albaranes` `a` left join `fza_almacenes` `alm` on(`alm`.`CODIGO_ALM_ALM` = `a`.`CODIGO_ALM_ALB`));

DROP VIEW IF EXISTS `vi_albaranes_compra`;

CREATE ALGORITHM=UNDEFINED  VIEW `vi_albaranes_compra` AS select `a`.`NUMERO_ALBC` AS `NUMERO_ALBC`,`a`.`SERIE_ALBC` AS `SERIE_ALBC`,`a`.`FECHA_ALBC` AS `FECHA_ALBC`,`a`.`ESTADO_ALBC` AS `ESTADO_ALBC`,`a`.`NUMERO_PED_ALBC` AS `NUMERO_PED_ALBC`,`a`.`SERIE_PED_ALBC` AS `SERIE_PED_ALBC`,`a`.`NUMERO_FAC_ALBC` AS `NUMERO_FAC_ALBC`,`a`.`SERIE_FAC_ALBC` AS `SERIE_FAC_ALBC`,`a`.`CODIGO_EMP_ALBC` AS `CODIGO_EMP_ALBC`,`a`.`RAZON_SOCIAL_EMPRESA_ALBC` AS `RAZON_SOCIAL_EMPRESA_ALBC`,`a`.`NIF_EMPRESA_ALBC` AS `NIF_EMPRESA_ALBC`,`a`.`MOVIL_EMPRESA_ALBC` AS `MOVIL_EMPRESA_ALBC`,`a`.`EMAIL_EMPRESA_ALBC` AS `EMAIL_EMPRESA_ALBC`,`a`.`DIRECCION1_EMPRESA_ALBC` AS `DIRECCION1_EMPRESA_ALBC`,`a`.`DIRECCION2_EMPRESA_ALBC` AS `DIRECCION2_EMPRESA_ALBC`,`a`.`POBLACION_EMPRESA_ALBC` AS `POBLACION_EMPRESA_ALBC`,`a`.`PROVINCIA_EMPRESA_ALBC` AS `PROVINCIA_EMPRESA_ALBC`,`a`.`CODIGO_PAI_EMPRESA_ALBC` AS `CODIGO_PAI_EMPRESA_ALBC`,`a`.`NOMBRE_PAI_EMPRESA_ALBC` AS `NOMBRE_PAI_EMPRESA_ALBC`,`a`.`CODIGO_POSTAL_EMPRESA_ALBC` AS `CODIGO_POSTAL_EMPRESA_ALBC`,`a`.`CODIGO_PRV_ALBC` AS `CODIGO_PRV_ALBC`,`a`.`RAZON_SOCIAL_PRV_ALBC` AS `RAZON_SOCIAL_PRV_ALBC`,`a`.`NIF_PRV_ALBC` AS `NIF_PRV_ALBC`,`a`.`MOVIL_PRV_ALBC` AS `MOVIL_PRV_ALBC`,`a`.`EMAIL_PRV_ALBC` AS `EMAIL_PRV_ALBC`,`a`.`DIRECCION1_PRV_ALBC` AS `DIRECCION1_PRV_ALBC`,`a`.`DIRECCION2_PRV_ALBC` AS `DIRECCION2_PRV_ALBC`,`a`.`POBLACION_PRV_ALBC` AS `POBLACION_PRV_ALBC`,`a`.`PROVINCIA_PRV_ALBC` AS `PROVINCIA_PRV_ALBC`,`a`.`CODIGO_PAI_PRV_ALBC` AS `CODIGO_PAI_PRV_ALBC`,`a`.`NOMBRE_PAI_PRV_ALBC` AS `NOMBRE_PAI_PRV_ALBC`,`a`.`CODIGO_POSTAL_PRV_ALBC` AS `CODIGO_POSTAL_PRV_ALBC`,`a`.`REF_PROVEEDOR_ALBC` AS `REF_PROVEEDOR_ALBC`,`a`.`CODIGO_ALM_ALBC` AS `CODIGO_ALM_ALBC`,`a`.`TRANSPORTISTA_ALBC` AS `TRANSPORTISTA_ALBC`,`a`.`CODIGO_IVA_ALBC` AS `CODIGO_IVA_ALBC`,`a`.`ESIVA_RECARGO_COMPRAS_ALBC` AS `ESIVA_RECARGO_COMPRAS_ALBC`,`a`.`ESIVA_EXENTO_INTRACOMUNITARIO_ALBC` AS `ESIVA_EXENTO_INTRACOMUNITARIO_ALBC`,`a`.`PORCENTAJE_IVAN_ALBC` AS `PORCENTAJE_IVAN_ALBC`,`a`.`TOTAL_BASEI_IVAN_ALBC` AS `TOTAL_BASEI_IVAN_ALBC`,`a`.`TOTAL_IVAN_ALBC` AS `TOTAL_IVAN_ALBC`,`a`.`PORCENTAJE_REN_ALBC` AS `PORCENTAJE_REN_ALBC`,`a`.`TOTAL_REN_ALBC` AS `TOTAL_REN_ALBC`,`a`.`PORCENTAJE_IVAR_ALBC` AS `PORCENTAJE_IVAR_ALBC`,`a`.`TOTAL_BASEI_IVAR_ALBC` AS `TOTAL_BASEI_IVAR_ALBC`,`a`.`TOTAL_IVAR_ALBC` AS `TOTAL_IVAR_ALBC`,`a`.`PORCENTAJE_RER_ALBC` AS `PORCENTAJE_RER_ALBC`,`a`.`TOTAL_RER_ALBC` AS `TOTAL_RER_ALBC`,`a`.`PORCENTAJE_IVAS_ALBC` AS `PORCENTAJE_IVAS_ALBC`,`a`.`TOTAL_BASEI_IVAS_ALBC` AS `TOTAL_BASEI_IVAS_ALBC`,`a`.`TOTAL_IVAS_ALBC` AS `TOTAL_IVAS_ALBC`,`a`.`PORCENTAJE_RES_ALBC` AS `PORCENTAJE_RES_ALBC`,`a`.`TOTAL_RES_ALBC` AS `TOTAL_RES_ALBC`,`a`.`PORCENTAJE_IVAE_ALBC` AS `PORCENTAJE_IVAE_ALBC`,`a`.`TOTAL_BASEI_IVAE_ALBC` AS `TOTAL_BASEI_IVAE_ALBC`,`a`.`TOTAL_IVAE_ALBC` AS `TOTAL_IVAE_ALBC`,`a`.`PORCENTAJE_REE_ALBC` AS `PORCENTAJE_REE_ALBC`,`a`.`TOTAL_REE_ALBC` AS `TOTAL_REE_ALBC`,`a`.`TOTAL_BASES_ALBC` AS `TOTAL_BASES_ALBC`,`a`.`TOTAL_IMPUESTOS_ALBC` AS `TOTAL_IMPUESTOS_ALBC`,`a`.`PORCENTAJE_RETENCION_ALBC` AS `PORCENTAJE_RETENCION_ALBC`,`a`.`TOTAL_RETENCION_ALBC` AS `TOTAL_RETENCION_ALBC`,`a`.`TOTAL_BRUTO_ALBC` AS `TOTAL_BRUTO_ALBC`,`a`.`PORCENTAJE_DTO_COMERCIAL_ALBC` AS `PORCENTAJE_DTO_COMERCIAL_ALBC`,`a`.`TOTAL_DTO_COMERCIAL_ALBC` AS `TOTAL_DTO_COMERCIAL_ALBC`,`a`.`PORCENTAJE_DTO_FINANCIERO_ALBC` AS `PORCENTAJE_DTO_FINANCIERO_ALBC`,`a`.`TOTAL_DTO_FINANCIERO_ALBC` AS `TOTAL_DTO_FINANCIERO_ALBC`,`a`.`TOTAL_LIQUIDO_ALBC` AS `TOTAL_LIQUIDO_ALBC`,`a`.`FORMA_PAGO_ALBC` AS `FORMA_PAGO_ALBC`,`a`.`ID_PV_TEMPORADA_ALBC` AS `ID_PV_TEMPORADA_ALBC`,`a`.`CONTADOR_LINEAS_ALBC` AS `CONTADOR_LINEAS_ALBC`,`a`.`COMENTARIOS_ALBC` AS `COMENTARIOS_ALBC`,`a`.`OBSERVACIONES_ALBC` AS `OBSERVACIONES_ALBC`,`a`.`ESPIVOTE_HORIZONTAL_ALBC` AS `ESPIVOTE_HORIZONTAL_ALBC`,`a`.`CODIGO_TAR_ALBC` AS `CODIGO_TAR_ALBC`,`a`.`ESDEPOSITO_ALBC` AS `ESDEPOSITO_ALBC`,`a`.`INSTANTE_MODIF` AS `INSTANTE_MODIF`,`a`.`INSTANTE_ALTA` AS `INSTANTE_ALTA`,`a`.`USUARIO_ALTA` AS `USUARIO_ALTA`,`a`.`USUARIO_MODIF` AS `USUARIO_MODIF`,`prv`.`NOMBRE_PRV` AS `NOMBRE_PRV_ALBC`,`emp`.`RAZON_SOCIAL_EMP` AS `RAZON_SOCIAL_EMPRESA_VIEW_ALBC`,`tp`.`PV` AS `TEMPORADA_ALBC`,`a`.`FECHA_ALBC` AS `FECHA_REALIZACION_ALBC`,`a`.`FECHA_ALBC` AS `FECHA_EFECTO_STOCK_ALBC`,`p`.`FECHA_TOPE_RECEPCION_PEDC` AS `FECHA_TOPE_RECEPCION_ALBC`,coalesce(`r`.`TOTAL_PRENDAS_ALBC`,0) AS `TOTAL_PRENDAS_ALBC`,coalesce(`r`.`TOTAL_LINEAS_ALBC`,0) AS `TOTAL_LINEAS_ALBC` from (((((`fza_albaranes_compra` `a` left join `fza_proveedores` `prv` on(`prv`.`CODIGO_PRV_PRV` = `a`.`CODIGO_PRV_ALBC`)) left join `fza_empresas` `emp` on(`emp`.`CODIGO_EMP_EMP` = `a`.`CODIGO_EMP_ALBC`)) left join `fza_pedidos_compra` `p` on(`p`.`SERIE_PEDC` = `a`.`SERIE_PED_ALBC` and `p`.`NUMERO_PEDC` = `a`.`NUMERO_PED_ALBC`)) left join `fza_propiedades_valores` `tp` on(`tp`.`ID_PV_ARTPROP` = `p`.`ID_PV_TEMPORADA_PEDC` and `tp`.`ID_PROP_PV` = 'TEMPORADA')) left join (select `l`.`SERIE_ALBC_ALBCLIN` AS `SERIE_ALBC_ALBCLIN`,`l`.`NUMERO_ALBC_ALBCLIN` AS `NUMERO_ALBC_ALBCLIN`,coalesce(sum(coalesce(`l`.`TOTAL_UNIDADES_ALBCLIN`,`l`.`CANTIDAD_ALBCLIN`,0)),0) AS `TOTAL_PRENDAS_ALBC`,coalesce(sum(`l`.`TOTAL_ALBCLIN`),0) AS `TOTAL_LINEAS_ALBC` from `fza_albaranes_compra_lineas` `l` group by `l`.`SERIE_ALBC_ALBCLIN`,`l`.`NUMERO_ALBC_ALBCLIN`) `r` on(`r`.`SERIE_ALBC_ALBCLIN` = `a`.`SERIE_ALBC` and `r`.`NUMERO_ALBC_ALBCLIN` = `a`.`NUMERO_ALBC`));
...
CREATE ALGORITHM=UNDEFINED  VIEW `vi_empresas_series` AS select `s`.`CODIGO_SERIE_EMPSER` AS `CODIGO_SERIE_EMPSER`,`s`.`CODIGO_EMP_EMPSER` AS `CODIGO_EMP_EMPSER`,`s`.`CODIGO_ALM_EMPSER` AS `CODIGO_ALM_EMPSER`,`s`.`CODIGO_CAJA_EMPSER` AS `CODIGO_CAJA_EMPSER`,case when `e`.`ESTOKENS_CALENDARIO_NATURAL_EMP` = 'S' and nullif(trim(`s`.`SERIE_TOKENIZADA_EMPSER`),'') is not null and char_length(trim(`s`.`SERIE_TOKENIZADA_EMPSER`)) - char_length(replace(trim(`s`.`SERIE_TOKENIZADA_EMPSER`),'yyyy','')) in (0,4) and char_length(trim(`s`.`SERIE_TOKENIZADA_EMPSER`)) - char_length(replace(trim(`s`.`SERIE_TOKENIZADA_EMPSER`),'q','')) in (0,1) and char_length(trim(`s`.`SERIE_TOKENIZADA_EMPSER`)) - char_length(replace(trim(`s`.`SERIE_TOKENIZADA_EMPSER`),'mm','')) in (0,2) and char_length(trim(`s`.`SERIE_TOKENIZADA_EMPSER`)) - char_length(replace(trim(`s`.`SERIE_TOKENIZADA_EMPSER`),'dd','')) in (0,2) and (locate(cast('yyyy' as char charset binary),cast(trim(`s`.`SERIE_TOKENIZADA_EMPSER`) as char charset binary)) > 0 or locate(cast('q' as char charset binary),cast(trim(`s`.`SERIE_TOKENIZADA_EMPSER`) as char charset binary)) > 0 or locate(cast('mm' as char charset binary),cast(trim(`s`.`SERIE_TOKENIZADA_EMPSER`) as char charset binary)) > 0 or locate(cast('dd' as char charset binary),cast(trim(`s`.`SERIE_TOKENIZADA_EMPSER`) as char charset binary)) > 0) then replace(replace(replace(replace(trim(`s`.`SERIE_TOKENIZADA_EMPSER`),'yyyy',cast(year(curdate()) as char charset utf8mb4)),'mm',date_format(curdate(),'%m')),'dd',date_format(curdate(),'%d')),'q',cast(quarter(curdate()) as char charset utf8mb4)) else `s`.`EMPSER` end AS `EMPSER`,`s`.`SERIE_TOKENIZADA_EMPSER` AS `SERIE_TOKENIZADA_EMPSER`,`s`.`TIPO_DOC_EMPSER` AS `TIPO_DOC_EMPSER`,`s`.`SUBTIPO_EMPSER` AS `SUBTIPO_EMPSER`,`s`.`FECHA_DESDE_EMPSER` AS `FECHA_DESDE_EMPSER`,`s`.`FECHA_HASTA_EMPSER` AS `FECHA_HASTA_EMPSER`,`s`.`INSTANTE_MODIF` AS `INSTANTE_MODIF`,`s`.`INSTANTE_ALTA` AS `INSTANTE_ALTA`,`s`.`USUARIO_ALTA` AS `USUARIO_ALTA`,`s`.`USUARIO_MODIF` AS `USUARIO_MODIF` from (`fza_empresas_series` `s` left join `fza_empresas` `e` on(`e`.`CODIGO_EMP_EMP` = `s`.`CODIGO_EMP_EMPSER`));
...
CREATE ALGORITHM=UNDEFINED  VIEW `vi_facturas_compra` AS select `f`.`NUMERO_FACC` AS `NUMERO_FACC`,`f`.`SERIE_FACC` AS `SERIE_FACC`,`f`.`FECHA_FACC` AS `FECHA_FACC`,`f`.`FECHA_VALOR_FACC` AS `FECHA_VALOR_FACC`,`f`.`ESTADO_FACC` AS `ESTADO_FACC`,`f`.`DOC_EXTERNO_FACC` AS `DOC_EXTERNO_FACC`,`f`.`REF_PROVEEDOR_FACC` AS `REF_PROVEEDOR_FACC`,`f`.`CODIGO_EMP_FACC` AS `CODIGO_EMP_FACC`,`f`.`RAZON_SOCIAL_EMPRESA_FACC` AS `RAZON_SOCIAL_EMPRESA_FACC`,`f`.`NIF_EMPRESA_FACC` AS `NIF_EMPRESA_FACC`,`f`.`MOVIL_EMPRESA_FACC` AS `MOVIL_EMPRESA_FACC`,`f`.`EMAIL_EMPRESA_FACC` AS `EMAIL_EMPRESA_FACC`,`f`.`DIRECCION1_EMPRESA_FACC` AS `DIRECCION1_EMPRESA_FACC`,`f`.`DIRECCION2_EMPRESA_FACC` AS `DIRECCION2_EMPRESA_FACC`,`f`.`POBLACION_EMPRESA_FACC` AS `POBLACION_EMPRESA_FACC`,`f`.`PROVINCIA_EMPRESA_FACC` AS `PROVINCIA_EMPRESA_FACC`,`f`.`CODIGO_PAI_EMPRESA_FACC` AS `CODIGO_PAI_EMPRESA_FACC`,`f`.`NOMBRE_PAI_EMPRESA_FACC` AS `NOMBRE_PAI_EMPRESA_FACC`,`f`.`CODIGO_POSTAL_EMPRESA_FACC` AS `CODIGO_POSTAL_EMPRESA_FACC`,`f`.`CODIGO_PRV_FACC` AS `CODIGO_PRV_FACC`,`f`.`RAZON_SOCIAL_PRV_FACC` AS `RAZON_SOCIAL_PRV_FACC`,`f`.`NIF_PRV_FACC` AS `NIF_PRV_FACC`,`f`.`MOVIL_PRV_FACC` AS `MOVIL_PRV_FACC`,`f`.`EMAIL_PRV_FACC` AS `EMAIL_PRV_FACC`,`f`.`DIRECCION1_PRV_FACC` AS `DIRECCION1_PRV_FACC`,`f`.`DIRECCION2_PRV_FACC` AS `DIRECCION2_PRV_FACC`,`f`.`POBLACION_PRV_FACC` AS `POBLACION_PRV_FACC`,`f`.`PROVINCIA_PRV_FACC` AS `PROVINCIA_PRV_FACC`,`f`.`CODIGO_PAI_PRV_FACC` AS `CODIGO_PAI_PRV_FACC`,`f`.`NOMBRE_PAI_PRV_FACC` AS `NOMBRE_PAI_PRV_FACC`,`f`.`CODIGO_POSTAL_PRV_FACC` AS `CODIGO_POSTAL_PRV_FACC`,`f`.`CODIGO_ALM_FACC` AS `CODIGO_ALM_FACC`,`f`.`CODIGO_IVA_FACC` AS `CODIGO_IVA_FACC`,`f`.`ESIVA_RECARGO_COMPRAS_FACC` AS `ESIVA_RECARGO_COMPRAS_FACC`,`f`.`ESIVA_EXENTO_INTRACOMUNITARIO_FACC` AS `ESIVA_EXENTO_INTRACOMUNITARIO_FACC`,`f`.`PORCENTAJE_IVAN_FACC` AS `PORCENTAJE_IVAN_FACC`,`f`.`TOTAL_BASEI_IVAN_FACC` AS `TOTAL_BASEI_IVAN_FACC`,`f`.`TOTAL_IVAN_FACC` AS `TOTAL_IVAN_FACC`,`f`.`PORCENTAJE_REN_FACC` AS `PORCENTAJE_REN_FACC`,`f`.`TOTAL_REN_FACC` AS `TOTAL_REN_FACC`,`f`.`PORCENTAJE_IVAR_FACC` AS `PORCENTAJE_IVAR_FACC`,`f`.`TOTAL_BASEI_IVAR_FACC` AS `TOTAL_BASEI_IVAR_FACC`,`f`.`TOTAL_IVAR_FACC` AS `TOTAL_IVAR_FACC`,`f`.`PORCENTAJE_RER_FACC` AS `PORCENTAJE_RER_FACC`,`f`.`TOTAL_RER_FACC` AS `TOTAL_RER_FACC`,`f`.`PORCENTAJE_IVAS_FACC` AS `PORCENTAJE_IVAS_FACC`,`f`.`TOTAL_BASEI_IVAS_FACC` AS `TOTAL_BASEI_IVAS_FACC`,`f`.`TOTAL_IVAS_FACC` AS `TOTAL_IVAS_FACC`,`f`.`PORCENTAJE_RES_FACC` AS `PORCENTAJE_RES_FACC`,`f`.`TOTAL_RES_FACC` AS `TOTAL_RES_FACC`,`f`.`PORCENTAJE_IVAE_FACC` AS `PORCENTAJE_IVAE_FACC`,`f`.`TOTAL_BASEI_IVAE_FACC` AS `TOTAL_BASEI_IVAE_FACC`,`f`.`TOTAL_IVAE_FACC` AS `TOTAL_IVAE_FACC`,`f`.`PORCENTAJE_REE_FACC` AS `PORCENTAJE_REE_FACC`,`f`.`TOTAL_REE_FACC` AS `TOTAL_REE_FACC`,`f`.`PORCENTAJE_DTO_COMERCIAL_FACC` AS `PORCENTAJE_DTO_COMERCIAL_FACC`,`f`.`TOTAL_DTO_COMERCIAL_FACC` AS `TOTAL_DTO_COMERCIAL_FACC`,`f`.`PORCENTAJE_DTO_FINANCIERO_FACC` AS `PORCENTAJE_DTO_FINANCIERO_FACC`,`f`.`TOTAL_DTO_FINANCIERO_FACC` AS `TOTAL_DTO_FINANCIERO_FACC`,`f`.`PORCENTAJE_PRONTO_PAGO_FACC` AS `PORCENTAJE_PRONTO_PAGO_FACC`,`f`.`TOTAL_PRONTO_PAGO_FACC` AS `TOTAL_PRONTO_PAGO_FACC`,`f`.`PORCENTAJE_RAPPEL_FACC` AS `PORCENTAJE_RAPPEL_FACC`,`f`.`TOTAL_RAPPEL_FACC` AS `TOTAL_RAPPEL_FACC`,`f`.`PORCENTAJE_FINANCIACION_FACC` AS `PORCENTAJE_FINANCIACION_FACC`,`f`.`TOTAL_FINANCIACION_FACC` AS `TOTAL_FINANCIACION_FACC`,`f`.`TOTAL_PORTES_FACC` AS `TOTAL_PORTES_FACC`,`f`.`PORCENTAJE_RETENCION_FACC` AS `PORCENTAJE_RETENCION_FACC`,`f`.`TOTAL_RETENCION_FACC` AS `TOTAL_RETENCION_FACC`,`f`.`TOTAL_BRUTO_FACC` AS `TOTAL_BRUTO_FACC`,`f`.`TOTAL_BASES_FACC` AS `TOTAL_BASES_FACC`,`f`.`TOTAL_IMPUESTOS_FACC` AS `TOTAL_IMPUESTOS_FACC`,`f`.`TOTAL_FACC` AS `TOTAL_FACC`,`f`.`TOTAL_LIQUIDO_FACC` AS `TOTAL_LIQUIDO_FACC`,`f`.`FORMA_PAGO_FACC` AS `FORMA_PAGO_FACC`,`f`.`ID_PV_TEMPORADA_FACC` AS `ID_PV_TEMPORADA_FACC`,`f`.`ESAGRUPAR_ALBARANES_FACC` AS `ESAGRUPAR_ALBARANES_FACC`,`f`.`ENTIDAD_FACC` AS `ENTIDAD_FACC`,`f`.`OFICINA_FACC` AS `OFICINA_FACC`,`f`.`DIGITO_CONTROL_FACC` AS `DIGITO_CONTROL_FACC`,`f`.`CUENTA_FACC` AS `CUENTA_FACC`,`f`.`IBAN_FACC` AS `IBAN_FACC`,`f`.`CONTADOR_LINEAS_FACC` AS `CONTADOR_LINEAS_FACC`,`f`.`COMENTARIOS_FACC` AS `COMENTARIOS_FACC`,`f`.`OBSERVACIONES_FACC` AS `OBSERVACIONES_FACC`,`f`.`ESPIVOTE_HORIZONTAL_FACC` AS `ESPIVOTE_HORIZONTAL_FACC`,`f`.`INSTANTE_CONTABILIZACION_FACC` AS `INSTANTE_CONTABILIZACION_FACC`,`f`.`INSTANTE_MODIF` AS `INSTANTE_MODIF`,`f`.`INSTANTE_ALTA` AS `INSTANTE_ALTA`,`f`.`USUARIO_ALTA` AS `USUARIO_ALTA`,`f`.`USUARIO_MODIF` AS `USUARIO_MODIF`,`prv`.`NOMBRE_PRV` AS `NOMBRE_PRV_VIEW_FACC`,`emp`.`RAZON_SOCIAL_EMP` AS `RAZON_SOCIAL_EMPRESA_VIEW_FACC` from ((`fza_facturas_compra` `f` left join `fza_proveedores` `prv` on(`prv`.`CODIGO_PRV_PRV` = `f`.`CODIGO_PRV_FACC`)) left join `fza_empresas` `emp` on(`emp`.`CODIGO_EMP_EMP` = `f`.`CODIGO_EMP_FACC`));

DROP VIEW IF EXISTS `vi_facturas_compra_cab_print`;

CREATE ALGORITHM=UNDEFINED  VIEW `vi_facturas_compra_cab_print` AS select `fac`.`SERIE_FACC` AS `SERIE_FACC`,`fac`.`NUMERO_FACC` AS `NUMERO_FACC`,case when trim(coalesce(`fac`.`SERIE_FACC`,'')) = '' then trim(coalesce(`fac`.`NUMERO_FACC`,'')) when trim(coalesce(`fac`.`NUMERO_FACC`,'')) = '' then trim(coalesce(`fac`.`SERIE_FACC`,'')) else concat(trim(coalesce(`fac`.`SERIE_FACC`,'')),'.',trim(coalesce(`fac`.`NUMERO_FACC`,''))) end AS `DOCUMENTO_FORMATO`,`fac`.`FECHA_FACC` AS `FECHA_FACC`,`fac`.`ESTADO_FACC` AS `ESTADO_FACC`,`fac`.`REF_PROVEEDOR_FACC` AS `REF_PROVEEDOR_FACC`,`fac`.`COMENTARIOS_FACC` AS `COMENTARIOS_FACC`,`fac`.`OBSERVACIONES_FACC` AS `OBSERVACIONES_FACC`,`fac`.`CODIGO_EMP_FACC` AS `CODIGO_EMP_FACC`,`emp`.`RAZON_SOCIAL_EMP` AS `RAZON_SOCIAL_EMP`,`emp`.`DIRECCION1_EMP` AS `DIRECCION1_EMP`,`emp`.`CODIGO_POSTAL_EMP` AS `CODIGO_POSTAL_EMP`,`emp`.`POBLACION_EMP` AS `POBLACION_EMP`,`emp`.`PROVINCIA_EMP` AS `PROVINCIA_EMP`,`emp`.`NIF_EMP` AS `CIF_EMP`,`emp`.`MOVIL_EMP` AS `TELEFONO1_EMP`,`fac`.`CODIGO_PRV_FACC` AS `CODIGO_PRV_FACC`,`prv`.`RAZON_SOCIAL_PRV` AS `RAZON_SOCIAL_PRV`,`prv`.`DIRECCION1_PRV` AS `DIRECCION1_PRV`,`prv`.`CODIGO_POSTAL_PRV` AS `CODIGO_POSTAL_PRV`,`prv`.`POBLACION_PRV` AS `POBLACION_PRV`,`prv`.`PROVINCIA_PRV` AS `PROVINCIA_PRV`,`prv`.`NIF_PRV` AS `CIF_PRV`,coalesce(`prv`.`TELEFONO_PRV`,`prv`.`MOVIL_PRV`) AS `TELEFONO1_PRV`,`fac`.`CODIGO_ALM_FACC` AS `CODIGO_ALM_FACC`,`alm`.`NOMBRE_ALM_ALM` AS `NOMBRE_ALM_FACC`,`alm`.`DIRECCION_ALM` AS `DIRECCION_ALM_FACC`,`alm`.`CODIGO_POSTAL_ALM` AS `CODIGO_POSTAL_ALM_FACC`,`alm`.`POBLACION_ALM` AS `POBLACION_ALM_FACC`,`alm`.`PROVINCIA_ALM` AS `PROVINCIA_ALM_FACC`,`alm`.`TELEFONO_ALM` AS `TELEFONO_ALM_FACC`,`alm`.`EMAIL_ALM` AS `EMAIL_ALM_FACC`,`fac`.`CODIGO_IVA_FACC` AS `CODIGO_IVA_FACC`,`fac`.`ESIVA_RECARGO_COMPRAS_FACC` AS `ESIVA_RECARGO_COMPRAS_FACC`,`fac`.`PORCENTAJE_IVAN_FACC` AS `PORCENTAJE_IVAN_FACC`,`fac`.`TOTAL_BASEI_IVAN_FACC` AS `TOTAL_BASEI_IVAN_FACC`,`fac`.`TOTAL_IVAN_FACC` AS `TOTAL_IVAN_FACC`,`fac`.`PORCENTAJE_REN_FACC` AS `PORCENTAJE_REN_FACC`,`fac`.`TOTAL_REN_FACC` AS `TOTAL_REN_FACC`,`fac`.`PORCENTAJE_IVAR_FACC` AS `PORCENTAJE_IVAR_FACC`,`fac`.`TOTAL_BASEI_IVAR_FACC` AS `TOTAL_BASEI_IVAR_FACC`,`fac`.`TOTAL_IVAR_FACC` AS `TOTAL_IVAR_FACC`,`fac`.`PORCENTAJE_RER_FACC` AS `PORCENTAJE_RER_FACC`,`fac`.`TOTAL_RER_FACC` AS `TOTAL_RER_FACC`,`fac`.`PORCENTAJE_IVAS_FACC` AS `PORCENTAJE_IVAS_FACC`,`fac`.`TOTAL_BASEI_IVAS_FACC` AS `TOTAL_BASEI_IVAS_FACC`,`fac`.`TOTAL_IVAS_FACC` AS `TOTAL_IVAS_FACC`,`fac`.`PORCENTAJE_RES_FACC` AS `PORCENTAJE_RES_FACC`,`fac`.`TOTAL_RES_FACC` AS `TOTAL_RES_FACC`,`fac`.`PORCENTAJE_IVAE_FACC` AS `PORCENTAJE_IVAE_FACC`,`fac`.`TOTAL_BASEI_IVAE_FACC` AS `TOTAL_BASEI_IVAE_FACC`,`fac`.`TOTAL_IVAE_FACC` AS `TOTAL_IVAE_FACC`,`fac`.`PORCENTAJE_REE_FACC` AS `PORCENTAJE_REE_FACC`,`fac`.`TOTAL_REE_FACC` AS `TOTAL_REE_FACC`,`fac`.`PORCENTAJE_RETENCION_FACC` AS `PORCENTAJE_RETENCION_FACC`,`fac`.`TOTAL_RETENCION_FACC` AS `TOTAL_RETENCION_FACC`,`fac`.`TOTAL_BASES_FACC` AS `TOTAL_BASES_FACC`,`fac`.`TOTAL_IMPUESTOS_FACC` AS `TOTAL_IMPUESTOS_FACC`,`fac`.`TOTAL_LIQUIDO_FACC` AS `TOTAL_LIQUIDO_FACC`,`fac`.`INSTANTE_ALTA` AS `INSTANTE_ALTA`,`fac`.`USUARIO_ALTA` AS `USUARIO_ALTA`,(select coalesce(sum(`lin`.`CANTIDAD_FACCLIN`),0) from `fza_facturas_compra_lineas` `lin` where `lin`.`SERIE_FACC_FACCLIN` = `fac`.`SERIE_FACC` and `lin`.`NUMERO_FACC_FACCLIN` = `fac`.`NUMERO_FACC`) AS `TOTAL_UNIDADES_FACC`,(select coalesce(sum(`lin`.`TOTAL_FACCLIN`),0) from `fza_facturas_compra_lineas` `lin` where `lin`.`SERIE_FACC_FACCLIN` = `fac`.`SERIE_FACC` and `lin`.`NUMERO_FACC_FACCLIN` = `fac`.`NUMERO_FACC`) AS `TOTAL_LINEAS_FACC`,(select count(0) from `fza_facturas_compra_lineas` `lin` where `lin`.`SERIE_FACC_FACCLIN` = `fac`.`SERIE_FACC` and `lin`.`NUMERO_FACC_FACCLIN` = `fac`.`NUMERO_FACC`) AS `NUM_LINEAS_FACC` from (((`fza_facturas_compra` `fac` left join `fza_empresas` `emp` on(`emp`.`CODIGO_EMP_EMP` = `fac`.`CODIGO_EMP_FACC`)) left join `fza_proveedores` `prv` on(`prv`.`CODIGO_PRV_PRV` = `fac`.`CODIGO_PRV_FACC`)) left join `fza_almacenes` `alm` on(`alm`.`CODIGO_ALM_ALM` = `fac`.`CODIGO_ALM_FACC`));

DROP VIEW IF EXISTS `vi_facturas_compra_guias_print`;

CREATE ALGORITHM=UNDEFINED  VIEW `vi_facturas_compra_guias_print` AS with pos_acd as (select `acd`.`ID_AC_ACD` AS `ID_AC`,`acd`.`ID_AV_ACD` AS `ID_AV`,`av`.`AV` AS `AV`,row_number() over ( partition by `acd`.`ID_AC_ACD` order by `acd`.`ORDEN_ACD`,`acd`.`ID_AV_ACD`) AS `POSICION` from (`fza_atributos_conjuntos_det` `acd` join `fza_atributos_valores` `av` on(`av`.`ID_AV` = `acd`.`ID_AV_ACD`)))select `ac`.`ID_AC` AS `ID_AC`,`ac`.`NOMBRE_AC` AS `NOMBRE_AC`,coalesce(`ac`.`NOMBRE_CORTO_AC`,ucase(left(`ac`.`NOMBRE_AC`,8))) AS `NOMBRE_CORTO_AC`,max(case when `p`.`POSICION` = 1 then `p`.`AV` end) AS `T01`,max(case when `p`.`POSICION` = 2 then `p`.`AV` end) AS `T02`,max(case when `p`.`POSICION` = 3 then `p`.`AV` end) AS `T03`,max(case when `p`.`POSICION` = 4 then `p`.`AV` end) AS `T04`,max(case when `p`.`POSICION` = 5 then `p`.`AV` end) AS `T05`,max(case when `p`.`POSICION` = 6 then `p`.`AV` end) AS `T06`,max(case when `p`.`POSICION` = 7 then `p`.`AV` end) AS `T07`,max(case when `p`.`POSICION` = 8 then `p`.`AV` end) AS `T08`,max(case when `p`.`POSICION` = 9 then `p`.`AV` end) AS `T09`,max(case when `p`.`POSICION` = 10 then `p`.`AV` end) AS `T10`,max(case when `p`.`POSICION` = 11 then `p`.`AV` end) AS `T11`,max(case when `p`.`POSICION` = 12 then `p`.`AV` end) AS `T12`,max(case when `p`.`POSICION` = 13 then `p`.`AV` end) AS `T13`,max(case when `p`.`POSICION` = 14 then `p`.`AV` end) AS `T14`,max(case when `p`.`POSICION` = 15 then `p`.`AV` end) AS `T15`,max(case when `p`.`POSICION` = 16 then `p`.`AV` end) AS `T16`,max(case when `p`.`POSICION` = 17 then `p`.`AV` end) AS `T17`,max(case when `p`.`POSICION` = 18 then `p`.`AV` end) AS `T18`,max(case when `p`.`POSICION` = 19 then `p`.`AV` end) AS `T19`,max(case when `p`.`POSICION` = 20 then `p`.`AV` end) AS `T20` from (`fza_atributos_conjuntos` `ac` join `pos_acd` `p` on(`p`.`ID_AC` = `ac`.`ID_AC`)) where `p`.`POSICION` <= 20 and `ac`.`ESACTIVO_AC` = 'S' group by `ac`.`ID_AC`,`ac`.`NOMBRE_AC`,`ac`.`NOMBRE_CORTO_AC`;

DROP VIEW IF EXISTS `vi_facturas_compra_lin_print`;
...
CREATE ALGORITHM=UNDEFINED  VIEW `vi_pedidos` AS select `p`.`NUMERO_PED` AS `NUMERO_PED`,`p`.`SERIE_PED` AS `SERIE_PED`,`p`.`FECHA_PED` AS `FECHA_PED`,`p`.`ESCONSOLIDADO_PED` AS `ESCONSOLIDADO_PED`,`p`.`ESTADO_PED` AS `ESTADO_PED`,`p`.`FECHA_ENTREGA_PED` AS `FECHA_ENTREGA_PED`,`p`.`CODIGO_EMP_PED` AS `CODIGO_EMP_PED`,`p`.`CODIGO_ALM_PED` AS `CODIGO_ALM_PED`,`p`.`RAZON_SOCIAL_EMPRESA_PED` AS `RAZON_SOCIAL_EMPRESA_PED`,`p`.`NIF_EMPRESA_PED` AS `NIF_EMPRESA_PED`,`p`.`MOVIL_EMPRESA_PED` AS `MOVIL_EMPRESA_PED`,`p`.`EMAIL_EMPRESA_PED` AS `EMAIL_EMPRESA_PED`,`p`.`DIRECCION1_EMPRESA_PED` AS `DIRECCION1_EMPRESA_PED`,`p`.`DIRECCION2_EMPRESA_PED` AS `DIRECCION2_EMPRESA_PED`,`p`.`POBLACION_EMPRESA_PED` AS `POBLACION_EMPRESA_PED`,`p`.`PROVINCIA_EMPRESA_PED` AS `PROVINCIA_EMPRESA_PED`,`p`.`CODIGO_PAI_EMPRESA_PED` AS `CODIGO_PAI_EMPRESA_PED`,`p`.`NOMBRE_PAI_EMPRESA_PED` AS `NOMBRE_PAI_EMPRESA_PED`,`p`.`CODIGO_POSTAL_EMPRESA_PED` AS `CODIGO_POSTAL_EMPRESA_PED`,`p`.`ESRETENCIONES_EMPRESA_PED` AS `ESRETENCIONES_EMPRESA_PED`,`p`.`GRUPO_ZONA_IVA_EMPRESA_PED` AS `GRUPO_ZONA_IVA_EMPRESA_PED`,`p`.`ESREGIMENESPECIALAGRICOLA_EMPRESA_PED` AS `ESREGIMENESPECIALAGRICOLA_EMPRESA_PED`,`p`.`CODIGO_CLI_PED` AS `CODIGO_CLI_PED`,`p`.`NIF_CLIENTE_PED` AS `NIF_CLIENTE_PED`,`p`.`EMAIL_CLIENTE_PED` AS `EMAIL_CLIENTE_PED`,`p`.`REFERENCIAPS_PED` AS `REFERENCIAPS_PED`,`p`.`IDPS_PED` AS `IDPS_PED`,`p`.`FECHAPS_PED` AS `FECHAPS_PED`,`p`.`FORMAPAGOPS_PED` AS `FORMAPAGOPS_PED`,`p`.`TRANSPORTISTAPS_PED` AS `TRANSPORTISTAPS_PED`,`p`.`ESTADOPEDIDOPS_PED` AS `ESTADOPEDIDOPS_PED`,`p`.`ESTADOMENSAJEPS_PED` AS `ESTADOMENSAJEPS_PED`,`p`.`IDHILOPS_MENSAJES_PED` AS `IDHILOPS_MENSAJES_PED`,`p`.`NOMBRE_CLI_ENVIO_PED` AS `NOMBRE_CLI_ENVIO_PED`,`p`.`MOVIL_CLIENTE_ENVIO_PED` AS `MOVIL_CLIENTE_ENVIO_PED`,`p`.`DIRECCION1_CLIENTE_ENVIO_PED` AS `DIRECCION1_CLIENTE_ENVIO_PED`,`p`.`DIRECCION2_CLIENTE_ENVIO_PED` AS `DIRECCION2_CLIENTE_ENVIO_PED`,`p`.`POBLACION_CLIENTE_ENVIO_PED` AS `POBLACION_CLIENTE_ENVIO_PED`,`p`.`PROVINCIA_CLIENTE_ENVIO_PED` AS `PROVINCIA_CLIENTE_ENVIO_PED`,`p`.`CODIGO_POSTAL_CLIENTE_ENVIO_PED` AS `CODIGO_POSTAL_CLIENTE_ENVIO_PED`,`p`.`CODIGO_PAI_CLIENTE_ENVIO_PED` AS `CODIGO_PAI_CLIENTE_ENVIO_PED`,`p`.`NOMBRE_PAI_CLIENTE_ENVIO_PED` AS `NOMBRE_PAI_CLIENTE_ENVIO_PED`,`p`.`RAZON_SOCIAL_CLIENTE_FISCAL_PED` AS `RAZON_SOCIAL_CLIENTE_FISCAL_PED`,`p`.`MOVIL_CLIENTE_FISCAL_PED` AS `MOVIL_CLIENTE_FISCAL_PED`,`p`.`EMAIL_CLIENTE_FISCAL_PED` AS `EMAIL_CLIENTE_FISCAL_PED`,`p`.`DIRECCION1_CLIENTE_FISCAL_PED` AS `DIRECCION1_CLIENTE_FISCAL_PED`,`p`.`DIRECCION2_CLIENTE_FISCAL_PED` AS `DIRECCION2_CLIENTE_FISCAL_PED`,`p`.`POBLACION_CLIENTE_FISCAL_PED` AS `POBLACION_CLIENTE_FISCAL_PED`,`p`.`PROVINCIA_CLIENTE_FISCAL_PED` AS `PROVINCIA_CLIENTE_FISCAL_PED`,`p`.`CODIGO_POSTAL_CLIENTE_FISCAL_PED` AS `CODIGO_POSTAL_CLIENTE_FISCAL_PED`,`p`.`CODIGO_PAI_CLIENTE_FISCAL_PED` AS `CODIGO_PAI_CLIENTE_FISCAL_PED`,`p`.`NOMBRE_PAI_CLIENTE_FISCAL_PED` AS `NOMBRE_PAI_CLIENTE_FISCAL_PED`,`p`.`ESIVA_RECARGO_CLIENTE_PED` AS `ESIVA_RECARGO_CLIENTE_PED`,`p`.`ESIVA_EXENTO_CLIENTE_PED` AS `ESIVA_EXENTO_CLIENTE_PED`,`p`.`ESREGIMENESPECIALAGRICOLA_CLIENTE_PED` AS `ESREGIMENESPECIALAGRICOLA_CLIENTE_PED`,`p`.`ESRETENCIONES_CLIENTE_PED` AS `ESRETENCIONES_CLIENTE_PED`,`p`.`TARIFA_ARTICULO_CLIENTE_PED` AS `TARIFA_ARTICULO_CLIENTE_PED`,`p`.`ESIMP_INCL_TARIFA_CLIENTE_PED` AS `ESIMP_INCL_TARIFA_CLIENTE_PED`,`p`.`ESINTRACOMUNITARIO_CLIENTE_PED` AS `ESINTRACOMUNITARIO_CLIENTE_PED`,`p`.`ESIRPF_IMP_INCL_ZONA_IVA_PED` AS `ESIRPF_IMP_INCL_ZONA_IVA_PED`,`p`.`ESAPLICA_RE_ZONA_IVA_PED` AS `ESAPLICA_RE_ZONA_IVA_PED`,`p`.`ESIVAAGRICOLA_ZONA_IVA_PED` AS `ESIVAAGRICOLA_ZONA_IVA_PED`,`p`.`PALABRA_REPORTS_ZONA_IVA_PED` AS `PALABRA_REPORTS_ZONA_IVA_PED`,`p`.`CODIGO_IVA_PED` AS `CODIGO_IVA_PED`,`p`.`ESVENTA_ACTIVO_FIJO_PED` AS `ESVENTA_ACTIVO_FIJO_PED`,`p`.`PORCENTAJE_IVAN_PED` AS `PORCENTAJE_IVAN_PED`,`p`.`TOTAL_IVAN_PED` AS `TOTAL_IVAN_PED`,`p`.`PORCENTAJE_REN_PED` AS `PORCENTAJE_REN_PED`,`p`.`TOTAL_REN_PED` AS `TOTAL_REN_PED`,`p`.`TOTAL_BASEI_IVAN_PED` AS `TOTAL_BASEI_IVAN_PED`,`p`.`PORCENTAJE_IVAR_PED` AS `PORCENTAJE_IVAR_PED`,`p`.`TOTAL_IVAR_PED` AS `TOTAL_IVAR_PED`,`p`.`PORCENTAJE_RER_PED` AS `PORCENTAJE_RER_PED`,`p`.`TOTAL_RER_PED` AS `TOTAL_RER_PED`,`p`.`TOTAL_BASEI_IVAR_PED` AS `TOTAL_BASEI_IVAR_PED`,`p`.`PORCENTAJE_IVAS_PED` AS `PORCENTAJE_IVAS_PED`,`p`.`TOTAL_IVAS_PED` AS `TOTAL_IVAS_PED`,`p`.`PORCENTAJE_RES_PED` AS `PORCENTAJE_RES_PED`,`p`.`TOTAL_RES_PED` AS `TOTAL_RES_PED`,`p`.`TOTAL_BASEI_IVAS_PED` AS `TOTAL_BASEI_IVAS_PED`,`p`.`PORCENTAJE_IVAE_PED` AS `PORCENTAJE_IVAE_PED`,`p`.`TOTAL_IVAE_PED` AS `TOTAL_IVAE_PED`,`p`.`PORCENTAJE_REE_PED` AS `PORCENTAJE_REE_PED`,`p`.`TOTAL_REE_PED` AS `TOTAL_REE_PED`,`p`.`TOTAL_BASEI_IVAE_PED` AS `TOTAL_BASEI_IVAE_PED`,`p`.`TOTAL_BASES_PED` AS `TOTAL_BASES_PED`,`p`.`TOTAL_IMPUESTOS_PED` AS `TOTAL_IMPUESTOS_PED`,`p`.`FORMA_PAGO_PED` AS `FORMA_PAGO_PED`,`p`.`PORCENTAJE_RETENCION_PED` AS `PORCENTAJE_RETENCION_PED`,`p`.`TOTAL_RETENCION_PED` AS `TOTAL_RETENCION_PED`,`p`.`TOTAL_LIQUIDO_PED` AS `TOTAL_LIQUIDO_PED`,`p`.`TOTAL_PAGADOREALPS_PED` AS `TOTAL_PAGADOREALPS_PED`,`p`.`NUMERO_PED_ABONO_PED` AS `NUMERO_PED_ABONO_PED`,`p`.`SERIE_PED_ABONO_PED` AS `SERIE_PED_ABONO_PED`,`p`.`TEXTO_LEGAL_CLIENTE_PED` AS `TEXTO_LEGAL_CLIENTE_PED`,`p`.`TEXTO_LEGAL_EMPRESA_PED` AS `TEXTO_LEGAL_EMPRESA_PED`,`p`.`DOCUMENTO_PED` AS `DOCUMENTO_PED`,`p`.`COMENTARIOS_PED` AS `COMENTARIOS_PED`,`p`.`OBSERVACIONES_PED` AS `OBSERVACIONES_PED`,`p`.`CONTADOR_LINEAS_PED` AS `CONTADOR_LINEAS_PED`,`p`.`ESCREARARTICULOS_PED` AS `ESCREARARTICULOS_PED`,`p`.`ESDESCRIPCIONES_AMP_PED` AS `ESDESCRIPCIONES_AMP_PED`,`p`.`ESFECHADEENTREGA_PED` AS `ESFECHADEENTREGA_PED`,`p`.`INSTANTE_MODIF` AS `INSTANTE_MODIF`,`p`.`INSTANTE_ALTA` AS `INSTANTE_ALTA`,`p`.`USUARIO_ALTA` AS `USUARIO_ALTA`,`p`.`USUARIO_MODIF` AS `USUARIO_MODIF`,`alm`.`NOMBRE_ALM_ALM` AS `NOMBRE_ALM_PED` from (`fza_pedidos` `p` left join `fza_almacenes` `alm` on(`alm`.`CODIGO_ALM_ALM` = `p`.`CODIGO_ALM_PED`));
...
BEGIN
  ...
  UPDATE `fza_facturas`
     SET `TOTAL_BASES_FAC` = v_total_base,
         ...
         `TOTAL_LIQUIDO_FAC` =
           v_total_base + v_total_iva - v_total_retencion,
         `INSTANTE_MODIF` = NOW(),
...
BEGIN
  ...
  INSERT INTO `fza_facturas` (
    ...
    `NOMBRE_PAI_CLIENTE_FAC`, `CODIGO_IVA_FAC`,
    ...
    `PORCENTAJE_RETENCION_FAC`, `FORMA_PAGO_FAC`, `CONTADOR_LINEAS_FAC`,
    `INSTANTE_ALTA`, `USUARIO_ALTA`, `USUARIO_MODIF`)
  SELECT v_numero, v_serie, CURRENT_DATE(), 'BORRADOR', 'NORMAL',
         A.`CODIGO_EMP_ALB`, A.`RAZON_SOCIAL_EMPRESA_ALB`,
         A.`NIF_EMPRESA_ALB`, A.`MOVIL_EMPRESA_ALB`, A.`EMAIL_EMPRESA_ALB`,
         ...
         A.`NIF_CLIENTE_ALB`, A.`MOVIL_CLIENTE_ALB`, A.`EMAIL_CLIENTE_ALB`,
         A.`DIRECCION1_CLIENTE_ALB`, A.`DIRECCION2_CLIENTE_ALB`,
         A.`POBLACION_CLIENTE_ALB`, A.`PROVINCIA_CLIENTE_ALB`,
         A.`CODIGO_POSTAL_CLIENTE_ALB`, A.`CODIGO_PAI_CLIENTE_ALB`,
         A.`NOMBRE_PAI_CLIENTE_ALB`, A.`CODIGO_IVA_ALB`,
         ...
         A.`PORCENTAJE_RETENCION_ALB`, A.`FORMA_PAGO_ALB`, '0',
         NOW(), p_USUARIO, p_USUARIO
    FROM `fza_albaranes` A
   WHERE A.`NUMERO_ALB` = p_NUMERO_ALB
     AND A.`SERIE_ALB` = p_SERIE_ALB;
...
PRC: BEGIN
  ...
  SELECT IFNULL(`ESFACTURADA_ALBLIN`, 'N')
    INTO v_facturada
    FROM `fza_albaranes_lineas`
   WHERE `NUMERO_ALB_ALBLIN` = p_NUMERO_ALB
     AND `SERIE_ALB_ALBLIN` = p_SERIE_ALB
  ...
  IF v_facturada = 'S' THEN
    LEAVE PRC;
  END IF;
  SELECT IFNULL(CAST(NULLIF(`CONTADOR_LINEAS_FAC`, '') AS UNSIGNED), 0) + 10
    INTO v_contador_fac
    FROM `fza_facturas`
   WHERE `NUMERO_FAC` = p_NUMERO_FAC
     AND `SERIE_FAC` = p_SERIE_FAC
  ...
  SELECT p_NUMERO_FAC, p_SERIE_FAC, v_linea_fac,
         ...
         AL.`TIPO_CANTIDAD_ARTICULO_ALBLIN`, AL.`CANTIDAD_ALBLIN`,
         AL.`CODIGO_TAR_ALBLIN`, AL.`ESIMP_INCL_TARIFA_ALBLIN`,
         AL.`TIPO_IVA_ARTICULO_ALBLIN`, AL.`PORCENTAJE_IVA_ALBLIN`,
         AL.`PRECIO_VENTA_SIVA_ARTICULO_ALBLIN`,
         AL.`PRECIO_VENTA_CIVA_ARTICULO_ALBLIN`, AL.`TOTAL_ALBLIN`,
         AL.`CODIGO_ALMACEN_ALBLIN`, NOW(), p_USUARIO, p_USUARIO
...
BEGIN
  ...
  bucle: LOOP
    ...
    SET v_NUM_SALIDA = CONCAT('IVS', LEFT(SHA2(CONCAT_WS(CHAR(31),
      p_EMPRESA, p_ALMACEN, p_SERIE, p_NUMERO, v_LINEA), 256), 17));
    SET v_NUM_ENTRADA = CONCAT('IVE', LEFT(SHA2(CONCAT_WS(CHAR(31),
      p_EMPRESA, p_ALMACEN, p_SERIE, p_NUMERO, v_LINEA), 256), 17));
...
CREATE  PROCEDURE `PRC_GET_NEXT_CONT`(
  IN pTipoDoc varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  IN pUSUARIO_MODIF varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  OUT pcont varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci
)
BEGIN
  ...
  END IF;
  CALL `PRC_GET_NEXT_CONTADOR`(pTipoDoc, '-', vSerie, pUSUARIO_MODIF, pcont);
END $
...
CREATE  PROCEDURE `PRC_GET_NEXT_CONTADOR`(
  IN pTipoDoc varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  IN pEmpresa varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  IN pSerie varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  IN pUsuario varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  OUT pContador varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci
)
BEGIN
...
BEGIN
  ...
  INSERT INTO `fza_albaranes` (
    ...
    `PORCENTAJE_RETENCION_ALB`, `FORMA_PAGO_ALB`, `CONTADOR_LINEAS_ALB`,
    `INSTANTE_ALTA`, `USUARIO_ALTA`, `USUARIO_MODIF`)
