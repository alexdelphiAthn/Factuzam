...
-- Los inventarios aplicados por versiones anteriores podian tener una sola
-- pata. Se completa el par para que el recuento siga siendo un cierre fisico.
INSERT IGNORE INTO fza_movimientos_almacen
  (NUMERO_MOV, TIPO_DOC_MOV, SERIE_DOC_MOV, NUMERO_DOC_MOV, LINEA_MOV,
   ...
   CODIGO_ALM_CONTRA_MOV, CODIGO_CLI_MOV, CODIGO_PRV_MOV, ESACTIVO_MOV,
   ...
   LOTE_MOV, FECHA_CADUCIDAD_MOV, CODIGO_ALM_DOC_MOV,
   NUMERO_OPERACION_DOC_MOV, CODIGO_CAJA_DOC_MOV)
SELECT CONCAT('IVS', LEFT(SHA2(CONCAT_WS(CHAR(31),
         l.CODIGO_EMP_INVLIN, l.CODIGO_ALM_INVLIN, l.SERIE_INV_INVLIN,
         l.NUMERO_INV_INVLIN, l.LINEA_INVLIN), 256), 17)),
       'IN', l.SERIE_INV_INVLIN, l.NUMERO_INV_INVLIN, l.LINEA_INVLIN,
       l.CODIGO_EMP_INVLIN, l.CODIGO_ALM_INVLIN,
       DATE_SUB(IFNULL(l.FECHA_RECUENTO_INVLIN,
         TIMESTAMP(DATE_SUB(DATE(i.FECHA_INV), INTERVAL 1 DAY), '23:59:59')),
         INTERVAL 1 SECOND),
       l.CODIGO_ART_INVLIN, l.CODIGO_UNIDAD_INVLIN,
       l.DESCRIPCION_ARTICULO_INVLIN, 'S',
       IFNULL(l.CANTIDAD_TEORICA_INVLIN, 0),
       IFNULL(l.PRECIO_MEDIO_INVLIN, 0),
       IFNULL(l.CANTIDAD_TEORICA_INVLIN, 0) *
         IFNULL(l.PRECIO_MEDIO_INVLIN, 0),
       IFNULL(l.PRECIO_MEDIO_INVLIN, 0), NULL, NULL, NULL, 'S',
       NOW(), NOW(), l.USUARIO_ALTA, l.USUARIO_MODIF,
       NULL, NULL, NULL, NULL, '', NULL, l.CODIGO_ALM_INVLIN,
       NULL, NULL
...
INSERT IGNORE INTO fza_movimientos_almacen
  (NUMERO_MOV, TIPO_DOC_MOV, SERIE_DOC_MOV, NUMERO_DOC_MOV, LINEA_MOV,
   ...
   LOTE_MOV, FECHA_CADUCIDAD_MOV, CODIGO_ALM_DOC_MOV,
   NUMERO_OPERACION_DOC_MOV, CODIGO_CAJA_DOC_MOV)
SELECT CONCAT('IVE', LEFT(SHA2(CONCAT_WS(CHAR(31),
         l.CODIGO_EMP_INVLIN, l.CODIGO_ALM_INVLIN, l.SERIE_INV_INVLIN,
         l.NUMERO_INV_INVLIN, l.LINEA_INVLIN), 256), 17)),
       'IN', l.SERIE_INV_INVLIN, l.NUMERO_INV_INVLIN, l.LINEA_INVLIN,
       l.CODIGO_EMP_INVLIN, l.CODIGO_ALM_INVLIN,
       IFNULL(l.FECHA_RECUENTO_INVLIN,
         TIMESTAMP(DATE_SUB(DATE(i.FECHA_INV), INTERVAL 1 DAY), '23:59:59')),
       l.CODIGO_ART_INVLIN, l.CODIGO_UNIDAD_INVLIN,
       l.DESCRIPCION_ARTICULO_INVLIN, 'E',
       IFNULL(l.CANTIDAD_FISICA_INVLIN, 0),
       IFNULL(l.PRECIO_MEDIO_NUEVO_INVLIN, 0),
       IFNULL(l.CANTIDAD_FISICA_INVLIN, 0) *
         IFNULL(l.PRECIO_MEDIO_NUEVO_INVLIN, 0),
       IFNULL(l.PRECIO_MEDIO_NUEVO_INVLIN, 0), NULL, NULL, NULL, 'S',
       NOW(), NOW(), l.USUARIO_ALTA, l.USUARIO_MODIF,
       NULL, NULL, NULL, NULL, '', NULL, l.CODIGO_ALM_INVLIN,
       NULL, NULL
  FROM fza_inventarios_lineas l
 ...
 WHERE i.ESTADO_INV = 'APLICADO'
   AND NOT EXISTS (
     SELECT 1
       FROM fza_movimientos_almacen e
      WHERE e.TIPO_DOC_MOV = 'IN'
        AND e.TIPO_MOV = 'E'
        AND e.CODIGO_ALM_MOV = l.CODIGO_ALM_INVLIN
        AND e.SERIE_DOC_MOV = l.SERIE_INV_INVLIN
        AND e.NUMERO_DOC_MOV = l.NUMERO_INV_INVLIN
        AND CAST(e.LINEA_MOV AS UNSIGNED) =
            CAST(l.LINEA_INVLIN AS UNSIGNED));
