...
-- =============================================================================
-- PRC_GET_NEXT_CONTADOR es la API unica. Los procedimientos antiguos quedan
-- como adaptadores para no romper sus consumidores actuales.
-- =============================================================================
...
CREATE PROCEDURE `PRC_GET_NEXT_CONT_FACT_SERIE`(
  IN pserie varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  IN pTipoDoc varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  IN pEMPRESA_CONTADOR varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  IN pUSUARIOMODIF varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci,
  OUT pcont varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci
)
BEGIN
  SET pEMPRESA_CONTADOR = COALESCE(NULLIF(TRIM(pEMPRESA_CONTADOR), ''), '-');
  SET pserie = COALESCE(NULLIF(TRIM(pserie), ''), '-');
  INSERT IGNORE INTO `fza_contadores` (
    `TIPO_DOC_CON`, `EMPRESA_CON`, `SERIE_CON`, `CON`,
    `NUM_DIGITOS_CON`, `ESACTIVO_CON`, `DEFAULT_CON`,
