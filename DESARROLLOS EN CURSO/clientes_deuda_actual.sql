...
--  ------------------------------------------------------------------------
--  Deuda = suma de (PRECIO_VENTA_DEP * CANTIDAD_PENDIENTE_DEP
--  - IMPORTE_ANTICIPO_DEP) de sus depositos/prestamos PENDIENTE (positivos):
--  lo que le falta por pagar de lo que se ha llevado. Los clientes sin
--  prestamos abiertos quedan a 0.
--
