...
$temporal = Join-Path $raizTemporal ('fzam_fase12b_' + $PID)
...
Anotar ('Compilación Fase XII-B - ' + (Get-Date -Format 'yyyy-MM-dd HH:mm:ss'))
...
$prefijoSeguro = $raizTemporal.TrimEnd('\') + '\fzam_fase12b_'
