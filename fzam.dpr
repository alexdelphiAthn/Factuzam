...
begin
  ...
  try
    try
      ...
      begin
        if EsCopiaTemporalValida(sRutaTemporal) then
        begin
          ARegistroLog.RegistrarInformacion(
...
begin
  ...
  var ParametrosProceso: TArray<string>;
  var ResultadoComandoCopia:
    TResultadoComandoCopiaSeguridad;
  ParametrosProceso := ObtenerParametrosProceso;
  EsModoComandoCopiaSeguridad :=
    EsComandoCopiaSeguridad(ParametrosProceso);
...
//  {$ENDIF}
  ...
  begin
    ResultadoComandoCopia := EjecutarComandoCopiaSeguridad(
      ParametrosProceso,
      RegistroLogAplicacion);
    RegistrarResultadoComando(
      ResultadoComandoCopia,
      RegistroLogAplicacion);
    RegistroLogAplicacion := nil;
    inLibLog.LiberarLog;
    ExitProcess(ResultadoComandoCopia.CodigoSalida);
  end;
